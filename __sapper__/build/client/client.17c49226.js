...
function Z(t, e, r) {
  const { fragment: a, on_mount: c, on_destroy: i, after_update: l } = t.$$
  a && a.m(e, r),
    H(() => {
...
function et(t, e) {
  ;-1 === t.$$.dirty[0] &&
    (q.push(t), D || ((D = !0), k.then(T)), t.$$.dirty.fill(0)),
    (t.$$.dirty[(e / 31) | 0] |= 1 << e % 31)
}
function nt(e, n, s, a, c, i, l = [-1]) {
  const u = R
  C(e)
  const f = n.props || {},
    p = (e.$$ = {
  ...
  if (
    ((p.ctx = s
      ? s(e, f, (t, n, ...r) => {
          ...
          return (
            p.ctx &&
              c(p.ctx[t], (p.ctx[t] = o)) &&
              (p.bound[t] && p.bound[t](o), d && et(e, t)),
            n
          )
        })
      : []),
    ...
    if (n.hydrate) {
      const t = _(n.target)
      p.fragment && p.fragment.l(t), t.forEach(h)
    } else p.fragment && p.fragment.c()
    n.intro && F(e.$$.fragment), Z(e, n.target, n.anchor), T()
  }
  C(u)
}
class rt {
...
function it(t) {
  ...
  return {
    ...
    m(t, r) {
      d(t, e, r), o && o.m(e, null), (n = !0)
    },
    p(t, [e]) {
      o && o.p && 1 & e && o.p(i(r, t, t[0], null), l(r, t[0], e, null))
    },
    i(t) {
      n || (F(o, t), (n = !0))
    },
...
function ft(e) {
  ...
  return (
    (document.title = n = e[0]),
    {
      c: t,
      l(t) {
        A('[data-svelte="svelte-1moakz"]', document.head).forEach(h)
      },
      m: t,
      p(t, [e]) {
        1 & e && n !== (n = t[0]) && (document.title = n)
      },
      i: t,
      o: t,
      d: t,
...
function pt(t, e, n) {
  ...
  return (
    (t.$set = (t) => {
      'status' in t && n(0, (r = t.status)), 'error' in t && n(1, (o = t.error))
    }),
    [r, o]
  )
}
class dt extends rt {
  constructor(t) {
    super(), nt(this, t, pt, ft, a, { status: 0, error: 1 })
  }
}
function ht(t) {
  let n, r
  ...
  return {
    ...
    l(t) {
      c && Q(c.$$.fragment, t), (n = y())
    },
    m(t, e) {
      c && Z(c, t, e), d(t, n, e), (r = !0)
    },
    p(t, e) {
      const r = 16 & e ? W(o, [X(t[4].props)]) : {}
    ...
    i(t) {
      r || (c && F(c.$$.fragment, t), (r = !0))
    },
    o(t) {
      c && G(c.$$.fragment, t), (r = !1)
    },
    d(t) {
      t && h(n), c && tt(c, t)
    },
...
function mt(t) {
  let e
  const n = new dt({ props: { error: t[0], status: t[1] } })
  return {
    c() {
      Y(n.$$.fragment)
    },
...
function $t(t) {
  ...
  let o = { $$slots: { default: [gt] }, $$scope: { ctx: t } }
  for (let t = 0; t < r.length; t += 1) o = e(o, r[t])
  const s = new ut({ props: o })
  return {
    c() {
      Y(s.$$.fragment)
    },
    ...
    p(t, [e]) {
      const n =
        12 & e
          ? W(r, [4 & e && { segment: t[2][0] }, 8 & e && X(t[3].props)])
          : {}
      83 & e && (n.$$scope = { dirty: e, ctx: t }), s.$set(n)
    },
    i(t) {
      n || (F(s.$$.fragment, t), (n = !0))
    },
    o(t) {
      G(s.$$.fragment, t), (n = !1)
    },
...
const vt = [/^\/stores\/?$/],
  _t = [
    { js: () => import('./index.29f82212.js'), css: [] },
    { js: () => import('./profile.ee3110ac.js'), css: [] },
    { js: () => import('./support.039d087f.js'), css: [] },
    { js: () => import('./store.76bd8298.js'), css: [] },
    { js: () => import('./chat.0f7245f4.js'), css: [] },
  ],
  St = [
    { pattern: /^\/$/, parts: [{ i: 0 }] },
    { pattern: /^\/profile\/?$/, parts: [{ i: 1 }] },
    { pattern: /^\/support\/?$/, parts: [{ i: 2 }] },
    { pattern: /^\/store\/?$/, parts: [{ i: 3 }] },
    { pattern: /^\/chat\/?$/, parts: [{ i: 4 }] },
  ]
const Et = 'undefined' != typeof __SAPPER__ && __SAPPER__
let wt,
  xt,
  Pt,
  At = !1,
  Rt = [],
  Ct = '{}'
const Lt = { page: st({}), preloading: st(null), session: st(Et && Et.session) }
let jt, qt
Lt.session.subscribe(async (t) => {
  if (((jt = t), !At)) return
  qt = !0
  const e = Bt(new URL(location.href)),
    n = (xt = {}),
    { redirect: r, props: o, branch: s } = await Kt(e)
  n === xt && (await zt(r, s, o, e.page))
})
let Nt,
  Ot = null
let Ut,
...
function Bt(t) {
  ...
  if (!t.pathname.startsWith(Et.baseUrl)) return null
  let e = t.pathname.slice(Et.baseUrl.length)
  if (('' === e && (e = '/'), !vt.some((t) => t.test(e))))
...
async function Jt(t, e, n, r) {
  if (e) Ut = e
    ...
    const t = Tt()
    ;(Ht[Ut] = t), (e = Ut = ++kt), (Ht[Ut] = n ? t : { x: 0, y: 0 })
  }
  ;(Ut = e), wt && Lt.preloading.set(!0)
  const o = Ot && Ot.href === t.href ? Ot.promise : Kt(t)
  Ot = null
  const s = (xt = {}),
    { redirect: a, props: c, branch: i } = await o
  if (
    s === xt &&
    (await zt(a, i, c, t.page),
    ...
    ;(Ht[Ut] = t), t && scrollTo(t.x, t.y)
  }
}
async function zt(t, e, n, r) {
  if (t)
    return (function (t, e = { replaceState: !1 }) {
      const n = Bt(new URL(t, document.baseURI))
      return n
        ? (Dt[e.replaceState ? 'replaceState' : 'pushState']({ id: Ut }, '', t),
          Jt(n, null).then(() => {}))
        : ((location.href = t), new Promise((t) => {}))
    })(t.location, { replaceState: !0 })
  if ((Lt.page.set(r), Lt.preloading.set(!1), wt)) wt.$set(n)
  else {
    ;(n.stores = {
      page: { subscribe: Lt.page.subscribe },
      preloading: { subscribe: Lt.preloading.subscribe },
      session: Lt.session,
    }),
      (n.level0 = { props: await Pt })
    const t = document.querySelector('#sapper-head-start'),
      e = document.querySelector('#sapper-head-end')
    if (t && e) {
      for (; t.nextSibling !== e; ) Vt(t.nextSibling)
      Vt(t), Vt(e)
    }
    wt = new bt({ target: Nt, props: n, hydrate: !0 })
  }
  ;(Rt = e), (Ct = JSON.stringify(r.query)), (At = !0), (qt = !1)
}
async function Kt(t) {
    ...
    c = await Promise.all(
      e.parts.map(async (e, c) => {
        ...
        if (
          ...
          return { segment: f }
        const p = i++
        if (!qt && !u && Rt[c] && Rt[c].part === e.i) return Rt[c]
        u = !1
        const { default: d, preload: h } = await (function (t) {
          const e = 'string' == typeof t.css ? [] : t.css.map(Mt)
...
function Ft(t) {
  const e = Bt(new URL(t, document.baseURI))
  if (e)
    return (
      (Ot && t === Ot.href) ||
        (function (t, e) {
...
function Yt(t) {
  ...
  const s = Bt(o)
  if (s) {
    Jt(s, null, e.hasAttribute('sapper-noscroll'), o.hash),
      t.preventDefault(),
      Dt.pushState({ id: Ut }, '', o.href)
  }
}
function Qt(t) {
...
function Zt(t) {
  if (((Ht[Ut] = Tt()), t.state)) {
    const e = Bt(new URL(location.href))
    e ? Jt(e, t.state.id) : (location.href = location.href)
  } else
    (kt = kt + 1),
      (function (t) {
        Ut = t
      })(kt),
      Dt.replaceState({ id: Ut }, '', location.href)
}
var te
;(te = { target: document.querySelector('#sapper') }),
  'scrollRestoration' in Dt && (Dt.scrollRestoration = 'manual'),
  (function (t) {
    Nt = t
  })(te.target),
  addEventListener('click', Yt),
  addEventListener('popstate', Zt),
  addEventListener('touchstart', Xt),
  addEventListener('mousemove', Wt),
  Promise.resolve().then(() => {
    const { hash: t, href: e } = location
    Dt.replaceState({ id: kt }, '', e)
    const n = new URL(location.href)
    if (Et.error)
      return (function (t) {
        const { host: e, pathname: n, search: r } = location,
          { session: o, preloaded: s, status: a, error: c } = Et
        Pt || (Pt = s && s[0]),
          zt(
            null,
            [],
            {
              ...
              session: o,
              level0: { props: Pt },
              level1: { props: { status: a, error: c }, component: dt },
              segments: s,
            },
            { host: e, path: n, query: It(r), params: {} }
          )
      })()
    const r = Bt(n)
    return r ? Jt(r, kt, !0, t) : void 0
  })
export {
  o as A,
  b as B,
