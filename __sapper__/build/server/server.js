...
const ProfileHeader = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<main><div id="${"head"}" class="${"svelte-ejxeh6"}"><div id="${"layer1"}" class="${"svelte-ejxeh6"}"></div>
    <div id="${"contentwrapper"}" class="${"svelte-ejxeh6"}"><div id="${"content"}" class="${"svelte-ejxeh6"}"><div id="${"profilepicture"}" style="${"background-image: url(" + escape(profilePicture) + ");"}" class="${"svelte-ejxeh6"}"></div>
        <div id="${"userinfo"}" class="${"svelte-ejxeh6"}"><h3 class="${"svelte-ejxeh6"}">${escape(alias)}</h3>
          <h5 class="${"svelte-ejxeh6"}">${escape(name)}</h5></div>
        
        <div id="${"level"}" class="${"svelte-ejxeh6"}">${escape(level)}</div>
        </div></div>
    <div id="${"layer2"}" style="${"background-image: url(gta.jpg);"}" class="${"svelte-ejxeh6"}"></div>
    <div id="${"layer3"}" class="${"svelte-ejxeh6"}"></div></div>
</main>`;
});
...
const css$7 = {
	code: "#badgeshowcase.svelte-4mhcix img.svelte-4mhcix{height:36px}#badgeshowcase.svelte-4mhcix.svelte-4mhcix{display:flex;justify-content:space-between;align-items:center}",
	map: "{\"version\":3,\"file\":\"Showcase.svelte\",\"sources\":[\"Showcase.svelte\"],\"sourcesContent\":[\"<script>\\n  export let images, height, borderRadius\\n</script>\\n\\n<div id=\\\"badgeshowcase\\\">\\n  <img src={images[0].link} style=\\\"height: {images[0].height}; border-radius: {images[0].borderRadius}\\\" />\\n  <img src={images[1].link} style=\\\"height: {images[1].height}; border-radius: {images[0].borderRadius}\\\" />\\n  <img src={images[2].link} style=\\\"height: {images[2].height}; border-radius: {images[0].borderRadius}\\\" />\\n  <img src={images[3].link} style=\\\"height: {images[3].height}; border-radius: {images[0].borderRadius}\\\" />\\n  <img src={images[4].link} style=\\\"height: {images[4].height}; border-radius: {images[0].borderRadius}\\\" />\\n</div>\\n\\n<style>\\n  #badgeshowcase img {\\n    height: 36px;\\n  }\\n\\n  #badgeshowcase {\\n    display: flex;\\n    justify-content: space-between;\\n    align-items: center;\\n  }\\n</style>\\n\"],\"names\":[],\"mappings\":\"AAaE,4BAAc,CAAC,GAAG,cAAC,CAAC,AAClB,MAAM,CAAE,IAAI,AACd,CAAC,AAED,cAAc,4BAAC,CAAC,AACd,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,aAAa,CAC9B,WAAW,CAAE,MAAM,AACrB,CAAC\"}"
};
...
const Showcase = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div id="${"badgeshowcase"}" class="${"svelte-4mhcix"}"><img${add_attribute("src", images[0].link, 0)} style="${"height: " + escape(images[0].height) + "; border-radius: " + escape(images[0].borderRadius)}" class="${"svelte-4mhcix"}">
  <img${add_attribute("src", images[1].link, 0)} style="${"height: " + escape(images[1].height) + "; border-radius: " + escape(images[0].borderRadius)}" class="${"svelte-4mhcix"}">
  <img${add_attribute("src", images[2].link, 0)} style="${"height: " + escape(images[2].height) + "; border-radius: " + escape(images[0].borderRadius)}" class="${"svelte-4mhcix"}">
  <img${add_attribute("src", images[3].link, 0)} style="${"height: " + escape(images[3].height) + "; border-radius: " + escape(images[0].borderRadius)}" class="${"svelte-4mhcix"}">
  <img${add_attribute("src", images[4].link, 0)} style="${"height: " + escape(images[4].height) + "; border-radius: " + escape(images[0].borderRadius)}" class="${"svelte-4mhcix"}">
</div>`;
});
...
const ProfileTile = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div${add_attribute("id", id, 0)} class="${"svelte-12c69u6"}"><div id="${"title"}" class="${"svelte-12c69u6"}"><h3 class="${"svelte-12c69u6"}">${escape(name)}</h3>
    <h2 class="${"svelte-12c69u6"}">${escape(number)}</h2></div>
  ${name === "Badges"
