...
const Showcase = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div id="${"badgeshowcase"}" class="${"svelte-mjq71y"}"><img${add_attribute("src", images[0].link, 0)} style="${"height: " + escape(images[0].height) + "; border-radius: " + escape(images[0].borderRadius)}" class="${"svelte-mjq71y"}">
  <img${add_attribute("src", images[1].link, 0)} style="${"height: " + escape(images[1].height) + "; border-radius: " + escape(images[0].borderRadius)}" class="${"svelte-mjq71y"}">
  <img${add_attribute("src", images[2].link, 0)} style="${"height: " + escape(images[2].height) + "; border-radius: " + escape(images[0].borderRadius)}" class="${"svelte-mjq71y"}">
  <img${add_attribute("src", images[3].link, 0)} style="${"height: " + escape(images[3].height) + "; border-radius: " + escape(images[0].borderRadius)}" class="${"svelte-mjq71y"}">
  <img${add_attribute("src", images[4].link, 0)} style="${"height: " + escape(images[4].height) + "; border-radius: " + escape(images[0].borderRadius)}" class="${"svelte-mjq71y"}">
</div>`;
});
...
const css$9 = {
	code: ".count.svelte-1aj5t8y{margin-right:12px;margin-top:6px}",
	map: "{\"version\":3,\"file\":\"LikeButton.svelte\",\"sources\":[\"LikeButton.svelte\"],\"sourcesContent\":[\"<script>\\n  export let update = false\\n  let count = 27\\n\\n  function likeUnlike() {\\n    update = !update\\n    if (update){\\n    \\tcount++\\n    } else{\\n    \\tcount--\\n    }\\n  }\\n</script>\\n<div class=\\\"count\\\">{count}</div>\\n          <img\\n            src={update ? 'like.svg' : 'likeidle.svg'}\\n            on:click={likeUnlike} />\\n\\n            <style>\\n            \\t\\n  .artwork--info .actions img {\\n    height: 16px;\\n  }\\n\\n  .count {\\n    margin-right: 12px;\\n    margin-top: 6px;\\n  }\\n            </style>\"],\"names\":[],\"mappings\":\"AAwBE,MAAM,eAAC,CAAC,AACN,YAAY,CAAE,IAAI,CAClB,UAAU,CAAE,GAAG,AACjB,CAAC\"}"
};
...
const LikeButton = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${"count svelte-1aj5t8y"}">${escape(count)}</div>
          <img${add_attribute("src", update ? "like.svg" : "likeidle.svg", 0)}>`;
});

/* src/components/Artwork.svelte generated by Svelte v3.22.2 */

const css$a = {
	code: "main.svelte-1l9r2pc.svelte-1l9r2pc{background-color:#0f0b20;padding:10px 15px;padding-right:0px;border-radius:2px;font-size:12px;line-height:18px;font-weight:300;grid-column:1/3;margin-top:15px}.artwork_container.svelte-1l9r2pc.svelte-1l9r2pc{display:flex;flex-direction:column}#title.svelte-1l9r2pc.svelte-1l9r2pc{justify-content:space-between;display:flex;padding-right:15px}h2.svelte-1l9r2pc.svelte-1l9r2pc{font-weight:500;color:#027aff}h3.svelte-1l9r2pc.svelte-1l9r2pc{color:#9099a1}#artwork.svelte-1l9r2pc.svelte-1l9r2pc{overflow-x:auto;overflow-y:hidden;white-space:nowrap;scroll-snap-type:x mandatory;margin-top:10px;display:flex;scrollbar-width:none}.artwork--item.svelte-1l9r2pc.svelte-1l9r2pc{height:200px;width:250px;background-color:#161c2d;display:inline-block;margin-right:10px;scroll-snap-stop:always;scroll-snap-align:center;background-position:center;background-repeat:no-repeat;background-size:cover;border-radius:2px}#artwork.svelte-1l9r2pc.svelte-1l9r2pc::-webkit-scrollbar{display:none}.artwork--info.svelte-1l9r2pc.svelte-1l9r2pc{display:flex;justify-content:space-between;margin-top:14px;padding:0 10px;align-items:center}.artwork--info.svelte-1l9r2pc .actions.svelte-1l9r2pc{margin-right:10px;display:flex;align-items:center}",
	map: "{\"version\":3,\"file\":\"Artwork.svelte\",\"sources\":[\"Artwork.svelte\"],\"sourcesContent\":[\"<script>\\nimport LikeButton from './LikeButton.svelte'\\n\\n</script>\\n\\n<main>\\n  <div id=\\\"title\\\">\\n    <h3>Artwork</h3>\\n    <h2>6</h2>\\n  </div>\\n  <div id=\\\"artwork\\\">\\n    <div class=\\\"artwork_container\\\">\\n      <div\\n        class=\\\"artwork--item\\\"\\n        style=\\\"background-image:\\n        url(https://cdnb.artstation.com/p/assets/images/images/013/913/993/large/rao-zhengang-0e1215a3-1791-4c60-aad9-633627659cf9.jpg?1541630208);\\\" />\\n      <div class=\\\"artwork--info\\\">\\n        <div class=\\\"title\\\">\\\"Ashen one\\\"</div>\\n        <div class=\\\"actions\\\">\\n          <LikeButton />\\n        </div>\\n      </div>\\n    </div>\\n    <div class=\\\"artwork_container\\\">\\n      <div\\n        class=\\\"artwork--item\\\"\\n        style=\\\"background-image:\\n        url(https://farm5.staticflickr.com/4610/39871466181_d6b592a9e1_b.jpg);\\\" />\\n      <div class=\\\"artwork--info\\\">\\n        <div class=\\\"title\\\">\\\"Too many shadows\\\"</div>\\n        <div class=\\\"actions\\\">\\n          <LikeButton />\\n        </div>\\n      </div>\\n    </div>\\n    <div class=\\\"artwork_container\\\">\\n      <div\\n        class=\\\"artwork--item\\\"\\n        style=\\\"background-image:\\n        url(https://cdnb.artstation.com/p/assets/images/images/005/617/333/large/omer-tunc-bloodborn-jpgg.jpg?1492494545);\\\" />\\n      <div class=\\\"artwork--info\\\">\\n        <div class=\\\"title\\\">\\\"You DIED\\\"</div>\\n        <div class=\\\"actions\\\">\\n          <LikeButton />\\n        </div>\\n      </div>\\n    </div>\\n    <div class=\\\"artwork_container\\\">\\n      <div\\n        class=\\\"artwork--item\\\"\\n        style=\\\"background-image:\\n        url(https://images.hdqwalls.com/download/sekiro-shadows-die-twice-digital-fan-art-6l-2560x1700.jpg);\\\" />\\n      <div class=\\\"artwork--info\\\">\\n        <div class=\\\"title\\\">\\\"Shadows die many times\\\"</div>\\n        <div class=\\\"actions\\\">\\n                <LikeButton />\\n        </div>\\n      </div>\\n    </div>\\n    <div class=\\\"artwork_container\\\">\\n      <div\\n        class=\\\"artwork--item\\\"\\n        style=\\\"background-image:\\n        url(https://pbs.twimg.com/media/D5QAdraWkAIQsCO.jpg);\\\" />\\n      <div class=\\\"artwork--info\\\">\\n        <div class=\\\"title\\\">\\\"Estus Flask\\\"</div>\\n        <div class=\\\"actions\\\">\\n                <LikeButton />\\n        </div>\\n      </div>\\n    </div>\\n    <div class=\\\"artwork_container\\\">\\n      <div\\n        class=\\\"artwork--item\\\"\\n        style=\\\"background-image:\\n        url(https://cdn.staticneo.com/ca/journey_conceptart_EaFXQ.jpg);\\\" />\\n      <div class=\\\"artwork--info\\\">\\n        <div class=\\\"title\\\">\\\"One short journey\\\"</div>\\n        <div class=\\\"actions\\\">\\n                <LikeButton />\\n        </div>\\n      </div>\\n    </div>\\n  </div>\\n</main>\\n\\n<style>\\n  main {\\n    background-color: #0f0b20;\\n    padding: 10px 15px;\\n    padding-right: 0px;\\n    border-radius: 2px;\\n    font-size: 12px;\\n    line-height: 18px;\\n    font-weight: 300;\\n    grid-column: 1/3;\\n    margin-top: 15px;\\n  }\\n\\n  .artwork_container {\\n    display: flex;\\n    flex-direction: column;\\n  }\\n\\n  #title {\\n    justify-content: space-between;\\n    display: flex;\\n    padding-right: 15px;\\n  }\\n\\n  h2 {\\n    font-weight: 500;\\n    color: #027aff;\\n  }\\n\\n  h3 {\\n    color: #9099a1;\\n  }\\n\\n  #artwork {\\n    overflow-x: auto;\\n    overflow-y: hidden;\\n    white-space: nowrap;\\n    scroll-snap-type: x mandatory;\\n    margin-top: 10px;\\n    display: flex;\\n    scrollbar-width: none;\\n  }\\n\\n  .artwork--item {\\n    height: 200px;\\n    width: 250px;\\n    background-color: #161c2d;\\n    display: inline-block;\\n    margin-right: 10px;\\n    scroll-snap-stop: always;\\n    scroll-snap-align: center;\\n    background-position: center;\\n    background-repeat: no-repeat;\\n    background-size: cover;\\n    border-radius: 2px;\\n  }\\n\\n  #artwork::-webkit-scrollbar {\\n    display: none;\\n  }\\n\\n  .artwork--info {\\n    display: flex;\\n    justify-content: space-between;\\n    margin-top: 14px;\\n    padding: 0 10px;\\n    align-items: center;\\n  }\\n\\n  .artwork--info .actions {\\n    margin-right: 10px;\\n    display: flex;\\n    align-items: center;\\n  }\\n</style>\\n\"],\"names\":[],\"mappings\":\"AAuFE,IAAI,8BAAC,CAAC,AACJ,gBAAgB,CAAE,OAAO,CACzB,OAAO,CAAE,IAAI,CAAC,IAAI,CAClB,aAAa,CAAE,GAAG,CAClB,aAAa,CAAE,GAAG,CAClB,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,IAAI,CACjB,WAAW,CAAE,GAAG,CAChB,WAAW,CAAE,CAAC,CAAC,CAAC,CAChB,UAAU,CAAE,IAAI,AAClB,CAAC,AAED,kBAAkB,8BAAC,CAAC,AAClB,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,AACxB,CAAC,AAED,MAAM,8BAAC,CAAC,AACN,eAAe,CAAE,aAAa,CAC9B,OAAO,CAAE,IAAI,CACb,aAAa,CAAE,IAAI,AACrB,CAAC,AAED,EAAE,8BAAC,CAAC,AACF,WAAW,CAAE,GAAG,CAChB,KAAK,CAAE,OAAO,AAChB,CAAC,AAED,EAAE,8BAAC,CAAC,AACF,KAAK,CAAE,OAAO,AAChB,CAAC,AAED,QAAQ,8BAAC,CAAC,AACR,UAAU,CAAE,IAAI,CAChB,UAAU,CAAE,MAAM,CAClB,WAAW,CAAE,MAAM,CACnB,gBAAgB,CAAE,CAAC,CAAC,SAAS,CAC7B,UAAU,CAAE,IAAI,CAChB,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,IAAI,AACvB,CAAC,AAED,cAAc,8BAAC,CAAC,AACd,MAAM,CAAE,KAAK,CACb,KAAK,CAAE,KAAK,CACZ,gBAAgB,CAAE,OAAO,CACzB,OAAO,CAAE,YAAY,CACrB,YAAY,CAAE,IAAI,CAClB,gBAAgB,CAAE,MAAM,CACxB,iBAAiB,CAAE,MAAM,CACzB,mBAAmB,CAAE,MAAM,CAC3B,iBAAiB,CAAE,SAAS,CAC5B,eAAe,CAAE,KAAK,CACtB,aAAa,CAAE,GAAG,AACpB,CAAC,AAED,sCAAQ,mBAAmB,AAAC,CAAC,AAC3B,OAAO,CAAE,IAAI,AACf,CAAC,AAED,cAAc,8BAAC,CAAC,AACd,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,aAAa,CAC9B,UAAU,CAAE,IAAI,CAChB,OAAO,CAAE,CAAC,CAAC,IAAI,CACf,WAAW,CAAE,MAAM,AACrB,CAAC,AAED,6BAAc,CAAC,QAAQ,eAAC,CAAC,AACvB,YAAY,CAAE,IAAI,CAClB,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,AACrB,CAAC\"}"
};

const Artwork = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	$$result.css.add(css$a);

	return `<main class="${"svelte-1l9r2pc"}"><div id="${"title"}" class="${"svelte-1l9r2pc"}"><h3 class="${"svelte-1l9r2pc"}">Artwork</h3>
    <h2 class="${"svelte-1l9r2pc"}">6</h2></div>
  <div id="${"artwork"}" class="${"svelte-1l9r2pc"}"><div class="${"artwork_container svelte-1l9r2pc"}"><div class="${"artwork--item svelte-1l9r2pc"}" style="${"background-image:\n        url(https://cdnb.artstation.com/p/assets/images/images/013/913/993/large/rao-zhengang-0e1215a3-1791-4c60-aad9-633627659cf9.jpg?1541630208);"}"></div>
      <div class="${"artwork--info svelte-1l9r2pc"}"><div class="${"title"}">&quot;Ashen one&quot;</div>
        <div class="${"actions svelte-1l9r2pc"}">${validate_component(LikeButton, "LikeButton").$$render($$result, {}, {}, {})}</div></div></div>
    <div class="${"artwork_container svelte-1l9r2pc"}"><div class="${"artwork--item svelte-1l9r2pc"}" style="${"background-image:\n        url(https://farm5.staticflickr.com/4610/39871466181_d6b592a9e1_b.jpg);"}"></div>
      <div class="${"artwork--info svelte-1l9r2pc"}"><div class="${"title"}">&quot;Too many shadows&quot;</div>
        <div class="${"actions svelte-1l9r2pc"}">${validate_component(LikeButton, "LikeButton").$$render($$result, {}, {}, {})}</div></div></div>
    <div class="${"artwork_container svelte-1l9r2pc"}"><div class="${"artwork--item svelte-1l9r2pc"}" style="${"background-image:\n        url(https://cdnb.artstation.com/p/assets/images/images/005/617/333/large/omer-tunc-bloodborn-jpgg.jpg?1492494545);"}"></div>
      <div class="${"artwork--info svelte-1l9r2pc"}"><div class="${"title"}">&quot;You DIED&quot;</div>
        <div class="${"actions svelte-1l9r2pc"}">${validate_component(LikeButton, "LikeButton").$$render($$result, {}, {}, {})}</div></div></div>
    <div class="${"artwork_container svelte-1l9r2pc"}"><div class="${"artwork--item svelte-1l9r2pc"}" style="${"background-image:\n        url(https://images.hdqwalls.com/download/sekiro-shadows-die-twice-digital-fan-art-6l-2560x1700.jpg);"}"></div>
      <div class="${"artwork--info svelte-1l9r2pc"}"><div class="${"title"}">&quot;Shadows die many times&quot;</div>
        <div class="${"actions svelte-1l9r2pc"}">${validate_component(LikeButton, "LikeButton").$$render($$result, {}, {}, {})}</div></div></div>
    <div class="${"artwork_container svelte-1l9r2pc"}"><div class="${"artwork--item svelte-1l9r2pc"}" style="${"background-image:\n        url(https://pbs.twimg.com/media/D5QAdraWkAIQsCO.jpg);"}"></div>
      <div class="${"artwork--info svelte-1l9r2pc"}"><div class="${"title"}">&quot;Estus Flask&quot;</div>
        <div class="${"actions svelte-1l9r2pc"}">${validate_component(LikeButton, "LikeButton").$$render($$result, {}, {}, {})}</div></div></div>
    <div class="${"artwork_container svelte-1l9r2pc"}"><div class="${"artwork--item svelte-1l9r2pc"}" style="${"background-image:\n        url(https://cdn.staticneo.com/ca/journey_conceptart_EaFXQ.jpg);"}"></div>
      <div class="${"artwork--info svelte-1l9r2pc"}"><div class="${"title"}">&quot;One short journey&quot;</div>
        <div class="${"actions svelte-1l9r2pc"}">${validate_component(LikeButton, "LikeButton").$$render($$result, {}, {}, {})}</div></div></div></div>
</main>`;
});
