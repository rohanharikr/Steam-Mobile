...
const css = {
	code: "#navbar.svelte-5wl8yy{background-color:#0a1226;height:60px;display:flex;justify-content:space-between;align-items:center;padding:0px 30px;color:#9099a1;font-weight:500;font-size:16px}",
...
const Navbar = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${validate_component(Headroom, "Headroom").$$render($$result, { offset: 50, tolerance: 5 }, {}, {
		default: () => `<div id="${"navbar"}" class="${"svelte-5wl8yy"}"><div><img src="${"search.svg"}"></div>
