...
const SteamGuard = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div id="${"wrapper"}" class="${"svelte-1e36vn4"}"><div id="${"timerbar"}" style="${"width: " + escape(100 - percentage * 10) + "%; background-image: " + escape(percentage >= 7
	? "linear-gradient(145deg, rgba(173,40,33,1) 0%, rgba(173,40,33,1) 100%)"
	: "linear-gradient(145deg, rgba(0,0,255,1) 0%, rgba(163,68,201,1) 100%)") + ";"}" class="${"svelte-1e36vn4"}"></div>
  <div id="${"code"}" style="${"color: " + escape(percentage >= 7 ? "#AD2821" : "white")}" class="${"svelte-1e36vn4"}">${escape(code)}</div>
  <div id="${"username"}" class="${"svelte-1e36vn4"}">${escape(username_value)}</div>
</div>`;
});
...
<div id="${"guard"}" class="${"svelte-lmiees"}">${validate_component(SteamGuard, "SteamGuard").$$render($$result, {}, {}, {})}</div>
