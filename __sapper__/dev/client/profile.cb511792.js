...
function instance$4($$self, $$props, $$invalidate) {
	...
	const getImages = params => {
		if (name === "Badges") {
			...
			$$invalidate(3, images["C"] = "https://steamcommunity-a.akamaihd.net/public/images/badges/28_springcleaning2018/bronze_80.png", images);
