...
} from './client.55c8a436.js'
import { N as Navbar, T as Tabbar } from './Tabbar.86d2315f.js'
import { u as username } from './stores.c06ba6da.js'
...
function create_fragment$3(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      if (img.src !== (img_src_value = /*images*/ ctx[0][0].link))
        attr_dev(img, 'src', img_src_value)
    ...
    p: function update(ctx, [dirty]) {
      if (
        dirty & /*images*/ 1 &&
        img.src !== (img_src_value = /*images*/ ctx[0][0].link)
      ) {
        attr_dev(img, 'src', img_src_value)
      }
    },
