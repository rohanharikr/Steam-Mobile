...
class ProfileTile extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance$4, create_fragment$4, safe_not_equal, { name: 0, number: 1 });
...
function create_fragment$7(ctx) {
	...
	const profiletile = new ProfileTile({
			props: { name: "Badges", number: "8" },
			$$inline: true
		});
	...
	const block = {
		c: function create() {
			...
			t0 = space();
			create_component(profiletile.$$.fragment);
			t1 = space();
		...
		l: function claim(nodes) {
			...
			claim_component(profiletile.$$.fragment, main_nodes);
		...
		h: function hydrate() {
			...
			add_location(main, file$7, 9, 0, 285);
		},
		m: function mount(target, anchor) {
			insert_dev(target, main, anchor);
			mount_component(aboutmetile, main, null);
			append_dev(main, t0);
			mount_component(profiletile, main, null);
			append_dev(main, t1);
		...
		i: function intro(local) {
			...
			transition_in(profiletile.$$.fragment, local);
		...
		o: function outro(local) {
			...
			transition_out(profiletile.$$.fragment, local);
