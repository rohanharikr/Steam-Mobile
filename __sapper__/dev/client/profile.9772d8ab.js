...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h3, file$3, 7, 4, 145);
			add_location(h2, file$3, 8, 4, 165);
			attr_dev(div0, "id", "title");
			attr_dev(div0, "class", "svelte-dlhws");
			add_location(div0, file$3, 6, 2, 124);
			attr_dev(div1, "id", "badges");
			attr_dev(div1, "class", "svelte-dlhws");
			add_location(div1, file$3, 5, 0, 104);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div1, anchor);
			append_dev(div1, div0);
...
const file$5 = "Users/rohanharikumar/node_modules/svelte-routing/src/Link.svelte";
...
class Link extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance$7, create_fragment$7, safe_not_equal, { to: 6, replace: 7, state: 8, getProps: 9 });
