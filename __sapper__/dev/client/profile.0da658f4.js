import {
  ...
  T as onDestroy,
  U as assign,
  V as exclude_internal_props,
  W as empty,
  X as get_spread_update,
  Y as get_spread_object,
  C as createEventDispatcher,
  Z as set_attributes,
  F as listen_dev,
  r as query_selector_all,
} from './client.42302bd2.js'
import { N as Navbar, T as Tabbar } from './Tabbar.1f060f4d.js'
import { u as username } from './stores.8fc53322.js'
...
function instance$3($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$')
      console.warn(`<Showcase> was created with unknown prop '${key}'`)
  })
...
function create_fragment$4(ctx) {
  ...
  const showcase = new Showcase({ props: { images: '' }, $$inline: true })
...
function instance$4($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$')
      console.warn(`<ProfileTile> was created with unknown prop '${key}'`)
  })
