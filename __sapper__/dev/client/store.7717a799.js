...
} from './client.3db01468.js'
import { N as Navbar, T as Tabbar } from './Tabbar.8dd7f430.js'
...
function create_if_block_2(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(img, file$1, 19, 8, 420)
    },
    m: function mount(target, anchor) {
...
function create_if_block_1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(img, file$1, 22, 8, 497)
    },
    m: function mount(target, anchor) {
      insert_dev(target, img, anchor)
    },
...
function create_if_block(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(img, 'height', '15px;')
      set_style(img, 'margin-left', '4px')
      add_location(img, file$1, 25, 8, 597)
    },
    m: function mount(target, anchor) {
      insert_dev(target, img, anchor)
    },
...
function create_fragment$1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(div0, 'class', 'svelte-4s5p5c')
      add_location(div0, file$1, 12, 2, 194)
      attr_dev(div1, 'id', 'owners')
      attr_dev(div1, 'class', 'svelte-4s5p5c')
      add_location(div1, file$1, 16, 4, 334)
      add_location(div2, file$1, 17, 4, 386)
      attr_dev(div3, 'id', 'cardInfo')
      attr_dev(div3, 'class', 'svelte-4s5p5c')
      add_location(div3, file$1, 15, 2, 310)
      attr_dev(div4, 'id', 'card')
      attr_dev(div4, 'class', 'svelte-4s5p5c')
...
function create_if_block_2$1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(img, file$2, 19, 8, 442)
    },
    m: function mount(target, anchor) {
      insert_dev(target, img, anchor)
    },
...
function create_if_block_1$1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(img, 'height', '12px;')
      set_style(img, 'margin-left', '4px')
      add_location(img, file$2, 22, 8, 519)
    },
    m: function mount(target, anchor) {
      insert_dev(target, img, anchor)
    },
...
function create_if_block$1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(img, 'height', '12px;')
      set_style(img, 'margin-left', '4px')
      add_location(img, file$2, 25, 8, 619)
    },
    m: function mount(target, anchor) {
      insert_dev(target, img, anchor)
    },
...
function create_fragment$2(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(div0, 'id', 'image')
      set_style(div0, 'background-image', 'url(' + /*image*/ ctx[0] + ')')
      attr_dev(div0, 'class', 'svelte-8wwjr8')
      add_location(div0, file$2, 12, 2, 194)
      add_location(div1, file$2, 17, 4, 408)
      attr_dev(div2, 'id', 'cardInfo')
      attr_dev(div2, 'class', 'svelte-8wwjr8')
      add_location(div2, file$2, 15, 2, 323)
      attr_dev(div3, 'id', 'card')
      attr_dev(div3, 'class', 'svelte-8wwjr8')
...
function create_fragment$3(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(div0, 'class', 'svelte-nn9hlq')
      add_location(div0, file$3, 6, 4, 124)
      attr_dev(div1, 'id', 'image')
      set_style(div1, 'background-image', 'url(' + /*image*/ ctx[0] + ')')
      attr_dev(div1, 'class', 'svelte-nn9hlq')
      add_location(div1, file$3, 5, 2, 64)
      attr_dev(div2, 'id', 'cardInfo')
      add_location(div2, file$3, 8, 2, 175)
      attr_dev(div3, 'id', 'card')
      attr_dev(div3, 'class', 'svelte-nn9hlq')
