import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, e as element, t as text, c as claim_element, b as children, h as claim_text, f as detach_dev, j as attr_dev, l as add_location, k as set_style, m as insert_dev, n as append_dev, o as set_data_dev, p as noop, a as space, q as create_component, g as claim_space, u as claim_component, w as mount_component, x as transition_in, y as transition_out, z as destroy_component, D as null_to_empty, E as run_all, F as listen_dev, K as group_outros, L as check_outros, r as query_selector_all } from './client.69009381.js';
...
function create_if_block_1$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(ul, "class", "svelte-qg84f2");
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h30, "class", h30_class_value = "" + (null_to_empty(!/*offline*/ ctx[0] ? "selectedtab" : "") + " svelte-qg84f2"));
			add_location(h30, file$3, 15, 6, 269);
			attr_dev(h31, "class", h31_class_value = "" + (null_to_empty(/*offline*/ ctx[0] ? "selectedtab" : "") + " svelte-qg84f2"));
			add_location(h31, file$3, 22, 6, 432);
			attr_dev(div0, "id", "tabs");
			attr_dev(div0, "class", "svelte-qg84f2");
			add_location(div0, file$3, 14, 4, 247);
			attr_dev(div1, "id", "tabscontainer");
			attr_dev(div1, "class", "svelte-qg84f2");
			add_location(div1, file$3, 13, 2, 218);
			attr_dev(div2, "id", "card");
			attr_dev(div2, "class", "svelte-qg84f2");
		...
		p: function update(ctx, [dirty]) {
			if (!current || dirty & /*offline*/ 1 && h30_class_value !== (h30_class_value = "" + (null_to_empty(!/*offline*/ ctx[0] ? "selectedtab" : "") + " svelte-qg84f2"))) {
				attr_dev(h30, "class", h30_class_value);
			}

			if (!current || dirty & /*offline*/ 1 && h31_class_value !== (h31_class_value = "" + (null_to_empty(/*offline*/ ctx[0] ? "selectedtab" : "") + " svelte-qg84f2"))) {
