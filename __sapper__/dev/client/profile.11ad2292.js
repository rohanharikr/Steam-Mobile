...
} from './client.1d0967aa.js'
import { N as Navbar, T as Tabbar } from './Tabbar.5518717d.js'
import { u as username } from './stores.1aca9d18.js'
...
function create_fragment$3(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(img3, file$3, 9, 2, 248)
      ...
      add_location(img4, file$3, 10, 2, 303)
      attr_dev(div, 'id', 'badgeshowcase')
      attr_dev(div, 'class', 'svelte-soube2')
      add_location(div, file$3, 5, 0, 78)
    },
    m: function mount(target, anchor) {
      insert_dev(target, div, anchor)
      append_dev(div, img0)
