...
const components = [
  {
    js: () => import('./index.df8b0f82.js'),
    css: [],
  },
  {
    js: () => import('./profile.a384439d.js'),
    css: [],
  },
  {
    js: () => import('./support.41f6ac40.js'),
    css: [],
  },
  {
    js: () => import('./store.9db41e63.js'),
    css: [],
  },
  {
    js: () => import('./chat.4397afdc.js'),
    css: [],
  },
]
...
async function navigate(target, id, noscroll, hash) {
  ...
  const loaded =
    prefetching && prefetching.href === target.href
      ? prefetching.promise
  ...
  try {
    ...
    branch = await Promise.all(
      route.parts.map(async (part, i) => {
        ...
        const { default: component, preload } = await load_component(
          components[part.i]
        )
...
function load_component(component) {
  ...
  const promises =
    typeof component.css === 'string' ? [] : component.css.map(load_css)
...
export {
  ...
  exclude_internal_props as T,
  empty as U,
  group_outros as V,
  check_outros as W,
  get_spread_update as X,
  get_spread_object as Y,
  set_attributes as Z,
  space as a,
  children as b,
  claim_element as c,
  ...
  set_data_dev as o,
  noop as p,
  create_component as q,
  query_selector_all as r,
  safe_not_equal as s,
  text as t,
