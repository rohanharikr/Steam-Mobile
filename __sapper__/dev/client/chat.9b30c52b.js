...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h30, "class", h30_class_value = "" + (null_to_empty(!/*offline*/ ctx[0] ? "selectedtab" : "") + " svelte-1najpus"));
			add_location(h30, file$3, 15, 6, 269);
			attr_dev(h31, "class", h31_class_value = "" + (null_to_empty(/*offline*/ ctx[0] ? "selectedtab" : "") + " svelte-1najpus"));
		...
		p: function update(ctx, [dirty]) {
			if (!current || dirty & /*offline*/ 1 && h30_class_value !== (h30_class_value = "" + (null_to_empty(!/*offline*/ ctx[0] ? "selectedtab" : "") + " svelte-1najpus"))) {
				attr_dev(h30, "class", h30_class_value);
			}

			if (!current || dirty & /*offline*/ 1 && h31_class_value !== (h31_class_value = "" + (null_to_empty(/*offline*/ ctx[0] ? "selectedtab" : "") + " svelte-1najpus"))) {
