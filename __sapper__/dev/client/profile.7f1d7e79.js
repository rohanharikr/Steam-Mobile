...
function create_fragment$6(ctx) {
	...
	const groups = new Badges({ $$inline: true });
...
function instance$6($$self, $$props, $$invalidate) {
	...
	$$self.$capture_state = () => ({ AboutMeTile, Badges, Friends, Groups: Badges });
	return [];
}
