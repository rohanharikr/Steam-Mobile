...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			if (img0.src !== (img0_src_value = images[0].link)) attr_dev(img0, "src", img0_src_value);
			set_style(img0, "height", "32px");
			attr_dev(img0, "class", "svelte-soube2");
			add_location(img0, file$3, 5, 2, 97);
			if (img1.src !== (img1_src_value = images[1].link)) attr_dev(img1, "src", img1_src_value);
			set_style(img1, "height", "32px");
			attr_dev(img1, "class", "svelte-soube2");
			add_location(img1, file$3, 6, 2, 152);
			if (img2.src !== (img2_src_value = images[2].link)) attr_dev(img2, "src", img2_src_value);
			attr_dev(img2, "class", "svelte-soube2");
			add_location(img2, file$3, 7, 2, 207);
			if (img3.src !== (img3_src_value = images[3].link)) attr_dev(img3, "src", img3_src_value);
			set_style(img3, "height", "36px");
			attr_dev(img3, "class", "svelte-soube2");
			add_location(img3, file$3, 8, 2, 240);
			if (img4.src !== (img4_src_value = images[4].link)) attr_dev(img4, "src", img4_src_value);
			set_style(img4, "height", "38px");
			attr_dev(img4, "class", "svelte-soube2");
			add_location(img4, file$3, 9, 2, 295);
