import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, e as element, a as space, t as text, c as claim_element, b as children, f as detach_dev, g as claim_space, h as claim_text, j as attr_dev, k as set_style, l as add_location, D as null_to_empty, m as insert_dev, n as append_dev, o as set_data_dev, p as noop, q as create_component, u as claim_component, w as mount_component, x as transition_in, y as transition_out, z as destroy_component, E as run_all, F as listen_dev, K as group_outros, L as check_outros, r as query_selector_all } from './client.dfe83286.js';
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h30, "class", h30_class_value = "" + (null_to_empty(!/*offline*/ ctx[0] ? "selectedtab" : "") + " svelte-146ai4i"));
			add_location(h30, file$1, 14, 6, 269);
			attr_dev(h31, "class", h31_class_value = "" + (null_to_empty(/*offline*/ ctx[0] ? "selectedtab" : "") + " svelte-146ai4i"));
		...
		p: function update(ctx, [dirty]) {
			if (!current || dirty & /*offline*/ 1 && h30_class_value !== (h30_class_value = "" + (null_to_empty(!/*offline*/ ctx[0] ? "selectedtab" : "") + " svelte-146ai4i"))) {
				attr_dev(h30, "class", h30_class_value);
			}

			if (!current || dirty & /*offline*/ 1 && h31_class_value !== (h31_class_value = "" + (null_to_empty(/*offline*/ ctx[0] ? "selectedtab" : "") + " svelte-146ai4i"))) {
