...
import { u as username } from './stores.49330411.js'
...
function create_fragment$2(ctx) {
  ...
  const block = {
    c: function create() {
      ...
      div = element('div')
      t = text(
        'Hidetaka Miyazaki is god. Change my mind. Dank Souls has the\nbest lore in any videogame. Waiting for Elden Ring.'
      )
      this.h()
    },
    l: function claim(nodes) {
