...
const components = [
	{
		js: () => import('./index.d6afb39a.js'),
		css: []
	},
	{
		js: () => import('./profile.8ad0adc1.js'),
		css: []
	},
	{
		js: () => import('./support.eecdb52e.js'),
		css: []
	},
	{
		js: () => import('./store.f8b7a398.js'),
		css: []
	},
	{
		js: () => import('./chat.b1f0c77b.js'),
		css: []
	}
];
