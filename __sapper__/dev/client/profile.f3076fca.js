...
function create_fragment$5(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h3, file$5, 1, 2, 21);
			add_location(h2, file$5, 2, 2, 39);
			attr_dev(div, "id", "friends");
			attr_dev(div, "class", "svelte-19tonmv");
