...
function create_fragment$6(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h2, file$6, 3, 4, 63);
			attr_dev(div0, "id", "title");
			attr_dev(div0, "class", "svelte-19rtp6w");
			add_location(div0, file$6, 1, 2, 21);
			attr_dev(div1, "id", "friends");
			attr_dev(div1, "class", "svelte-19rtp6w");
...
function create_fragment$7(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			claim_component(comments.$$.fragment, main_nodes);
			main_nodes.forEach(detach_dev);
			this.h();
		},
		h: function hydrate() {
