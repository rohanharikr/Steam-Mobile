...
const components = [
	{
		js: () => import('./index.a0929643.js'),
		css: []
	},
	{
		js: () => import('./profile.59a622ef.js'),
		css: []
	},
	{
		js: () => import('./support.f1adecbe.js'),
		css: []
	},
	{
		js: () => import('./store.cfc49570.js'),
		css: []
	},
	{
		js: () => import('./chat.f2ecc43d.js'),
		css: []
	}
];
