...
} from './client.9859f3ba.js'
import { N as Navbar, T as Tabbar } from './Tabbar.73f4acd4.js'
import { u as username } from './stores.cfd6bb5a.js'
...
function create_fragment$3(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(img2, file$3, 7, 2, 156)
...
function instance$3($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$')
      console_1.warn(`<BadgeShowcase> was created with unknown prop '${key}'`)
  })
...
class BadgeShowcase extends SvelteComponentDev {
  constructor(options) {
    ...
    if (/*images*/ ctx[0] === undefined && !('images' in props)) {
      console_1.warn(
        "<BadgeShowcase> was created without expected prop 'images'"
      )
    }
  }
