...
} from './client.58ffb286.js'
import { N as Navbar, T as Tabbar } from './Tabbar.2fcf6b07.js'
...
function create_if_block_2(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(img, file$1, 19, 8, 423)
    },
    m: function mount(target, anchor) {
...
function create_if_block_1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(img, file$1, 22, 8, 500)
    },
    m: function mount(target, anchor) {
      insert_dev(target, img, anchor)
    },
...
function create_if_block(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(img, 'height', '15px;')
      set_style(img, 'margin-left', '4px')
      add_location(img, file$1, 25, 8, 600)
    },
    m: function mount(target, anchor) {
      insert_dev(target, img, anchor)
    },
...
function create_fragment$1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div1, file$1, 16, 4, 337)
      add_location(div2, file$1, 17, 4, 389)
      attr_dev(div3, 'id', 'cardInfo')
      attr_dev(div3, 'class', 'svelte-1jn8rt4')
      add_location(div3, file$1, 15, 2, 313)
...
function create_if_block_2$1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(img, file$2, 19, 8, 445)
    },
    m: function mount(target, anchor) {
      insert_dev(target, img, anchor)
    },
...
function create_if_block_1$1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(img, 'height', '12px;')
      set_style(img, 'margin-left', '4px')
      add_location(img, file$2, 22, 8, 522)
    },
    m: function mount(target, anchor) {
      insert_dev(target, img, anchor)
    },
...
function create_if_block$1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(img, 'height', '12px;')
      set_style(img, 'margin-left', '4px')
      add_location(img, file$2, 25, 8, 622)
    },
    m: function mount(target, anchor) {
      insert_dev(target, img, anchor)
    },
...
function create_fragment$2(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div1, file$2, 17, 4, 411)
      attr_dev(div2, 'id', 'cardInfo')
      attr_dev(div2, 'class', 'svelte-102btid')
      add_location(div2, file$2, 15, 2, 326)
