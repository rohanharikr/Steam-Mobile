...
function create_fragment$4(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h3, file$4, 7, 4, 154);
			add_location(h2, file$4, 8, 4, 174);
			attr_dev(div0, "id", "title");
			attr_dev(div0, "class", "svelte-1ye7e9i");
			add_location(div0, file$4, 6, 2, 133);
...
function instance$4($$self, $$props, $$invalidate) {
	...
	$$self.$capture_state = () => ({ MainBadge, Showcase: BadgeShowcase });
	return [];
}
