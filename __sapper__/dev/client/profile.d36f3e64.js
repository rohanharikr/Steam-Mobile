...
} from './client.10a03800.js'
import { N as Navbar, T as Tabbar } from './Tabbar.1cd47c0c.js'
import { u as username } from './stores.b68ff423.js'
...
function create_fragment$2(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(h2, 'class', 'svelte-1mbjc9c')
      add_location(h2, file$2, 3, 3, 154)
      attr_dev(h4, 'class', 'svelte-1mbjc9c')
      add_location(h4, file$2, 4, 3, 183)
      attr_dev(div0, 'id', 'badgemaininfo')
      attr_dev(div0, 'class', 'svelte-1mbjc9c')
      add_location(div0, file$2, 2, 2, 126)
      attr_dev(div1, 'id', 'badgemain')
      attr_dev(div1, 'class', 'svelte-1mbjc9c')
...
const file$3 = 'src/components/Badges.svelte'
...
function create_fragment$3(ctx) {
  ...
  const badges = new Badges_1({ $$inline: true })
  ...
  const block = {
    ...
    l: function claim(nodes) {
      ...
      claim_component(badges.$$.fragment, div1_nodes)
      div1_nodes.forEach(detach_dev)
      this.h()
    },
    h: function hydrate() {
      add_location(h3, file$3, 7, 2, 140)
      add_location(h2, file$3, 8, 2, 158)
      attr_dev(div0, 'id', 'title')
      attr_dev(div0, 'class', 'svelte-1bp9wki')
      add_location(div0, file$3, 6, 1, 121)
      attr_dev(div1, 'id', 'badges')
      attr_dev(div1, 'class', 'svelte-1bp9wki')
      add_location(div1, file$3, 5, 0, 102)
    },
    m: function mount(target, anchor) {
      insert_dev(target, div1, anchor)
      append_dev(div1, div0)
...
function instance$3($$self, $$props, $$invalidate) {
  ...
  $$self.$capture_state = () => ({ MainBadge, Badges: Badges_1 })
  return []
}

class Badges_1 extends SvelteComponentDev {
  constructor(options) {
    super(options)
...
function create_fragment$4(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(main, file$4, 9, 0, 280)
    },
    m: function mount(target, anchor) {
      insert_dev(target, main, anchor)
...
function instance$4($$self, $$props, $$invalidate) {
  ...
  $$self.$capture_state = () => ({ AboutMeTile, Badges: Badges_1 })
  return []
}
