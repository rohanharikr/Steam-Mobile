...
function instance$4($$self, $$props, $$invalidate) {
	...
	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$1.warn(`<ProfileTile> was created with unknown prop '${key}'`);
	});
...
class ProfileTile extends SvelteComponentDev {
	constructor(options) {
		...
		if (/*number*/ ctx[1] === undefined && !("number" in props)) {
			console_1$1.warn("<ProfileTile> was created without expected prop 'number'");
		}
		...
		if (/*images*/ ctx[3] === undefined && !("images" in props)) {
			console_1$1.warn("<ProfileTile> was created without expected prop 'images'");
		}
	}
