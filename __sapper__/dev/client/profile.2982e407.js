...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			if (img.src !== (img_src_value = "https://steamcommunity-a.akamaihd.net/public/images/badges/02_years/steamyears5_54.png")) attr_dev(img, "src", img_src_value);
			add_location(img, file$3, 1, 2, 23);
			attr_dev(h2, "class", "svelte-roddg3");
			add_location(h2, file$3, 4, 4, 159);
			attr_dev(h4, "class", "svelte-roddg3");
			add_location(h4, file$3, 5, 4, 189);
			attr_dev(div0, "id", "badgemaininfo");
			attr_dev(div0, "class", "svelte-roddg3");
			add_location(div0, file$3, 3, 2, 130);
			attr_dev(div1, "id", "badgemain");
			attr_dev(div1, "class", "svelte-roddg3");
