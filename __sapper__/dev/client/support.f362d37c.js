...
function create_fragment(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      if (img.src !== (img_src_value = /*logo*/ ctx[1]))
...
function instance($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$')
      console.warn(`<SupportCardItem> was created with unknown prop '${key}'`)
  })
...
class SupportCardItem extends SvelteComponentDev {
  constructor(options) {
    ...
    if (/*height*/ ctx[2] === undefined && !('height' in props)) {
      console.warn(
        "<SupportCardItem> was created without expected prop 'height'"
      )
    }
  }
  ...
  get name() {
    throw new Error(
      "<SupportCardItem>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'"
    )
  }

  set name(value) {
    throw new Error(
      "<SupportCardItem>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'"
    )
  }
...
function create_if_block_3(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(h3, 'class', 'svelte-14nwsoo')
...
function create_if_block_2(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(li0, 'class', 'svelte-14nwsoo')
      add_location(li0, file$1, 12, 6, 245)
      attr_dev(li1, 'class', 'svelte-14nwsoo')
      add_location(li1, file$1, 15, 6, 327)
      attr_dev(li2, 'class', 'svelte-14nwsoo')
...
function create_if_block_1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(li, 'class', 'svelte-14nwsoo')
...
function create_if_block(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(li3, 'class', 'svelte-14nwsoo')
      add_location(li3, file$1, 37, 6, 933)
      attr_dev(li4, 'class', 'svelte-14nwsoo')
...
function create_fragment$1(ctx) {
  ...
  let current
  let if_block0 =
    !(/*single*/ ctx[1]) && !(/*combined*/ ctx[3]) && create_if_block_3(ctx)
  let if_block1 =
    !(/*single*/ ctx[1]) && !(/*combined*/ ctx[3]) && create_if_block_2(ctx)
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(ul, 'class', 'svelte-14nwsoo')
...
function instance$1($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$')
      console.warn(`<SupportCard> was created with unknown prop '${key}'`)
  })
...
class SupportCard extends SvelteComponentDev {
  ...
  get title() {
    throw new Error(
      "<SupportCard>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'"
    )
  }

  set title(value) {
    throw new Error(
      "<SupportCard>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'"
    )
  }
...
function instance$2($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$')
      console.warn(`<Support> was created with unknown prop '${key}'`)
  })
