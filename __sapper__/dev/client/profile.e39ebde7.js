...
} from './client.789a191c.js'
import { N as Navbar, T as Tabbar } from './Tabbar.e089616f.js'
import { u as username } from './stores.01b11dee.js'
...
function create_fragment$1(ctx) {
  ...
  const block = {
    c: function create() {
      div = element('div')
      t = text(
        'Hidetaka Miyazaki is god. Change my mind. Dank Souls has the best lore in any videogame. Waiting for Elden Ring.'
      )
      this.h()
    },
    l: function claim(nodes) {
    ...
    h: function hydrate() {
      ...
      attr_dev(div, 'class', 'svelte-18qiap7')
...
const file$2 = 'src/components/Badges.svelte'
...
function create_fragment$2(ctx) {
  ...
  const block = {
    ...
    l: function claim(nodes) {
      ...
      var div4_nodes = children(div4)
      img = claim_element(div4_nodes, 'IMG', { src: true })
      t4 = claim_space(div4_nodes)
      div3 = claim_element(div4_nodes, 'DIV', { id: true, class: true })
      var div3_nodes = children(div3)
      div1 = claim_element(div3_nodes, 'DIV', { class: true })
      var div1_nodes = children(div1)
      t5 = claim_text(div1_nodes, 'Years of Service')
      div1_nodes.forEach(detach_dev)
      t6 = claim_space(div3_nodes)
      div2 = claim_element(div3_nodes, 'DIV', { class: true })
      var div2_nodes = children(div2)
      t7 = claim_text(div2_nodes, '250 XP')
      div2_nodes.forEach(detach_dev)
      div3_nodes.forEach(detach_dev)
      div4_nodes.forEach(detach_dev)
    ...
    h: function hydrate() {
      add_location(h3, file$2, 2, 2, 38)
      add_location(h2, file$2, 3, 2, 56)
      attr_dev(div0, 'id', 'title')
      attr_dev(div0, 'class', 'svelte-10edg9u')
      add_location(div0, file$2, 1, 1, 19)
      if (
        img.src !==
        (img_src_value =
      ...
      add_location(img, file$2, 6, 2, 99)
      attr_dev(div1, 'class', 'svelte-10edg9u')
      add_location(div1, file$2, 8, 3, 230)
      attr_dev(div2, 'class', 'svelte-10edg9u')
      add_location(div2, file$2, 9, 3, 261)
      attr_dev(div3, 'id', 'badgemaininfo')
      attr_dev(div3, 'class', 'svelte-10edg9u')
      add_location(div3, file$2, 7, 2, 202)
      attr_dev(div4, 'id', 'badgemain')
      attr_dev(div4, 'class', 'svelte-10edg9u')
      add_location(div4, file$2, 5, 1, 76)
      attr_dev(div5, 'id', 'badges')
      attr_dev(div5, 'class', 'svelte-10edg9u')
      add_location(div5, file$2, 12, 1, 297)
      attr_dev(div6, 'id', 'badges')
      attr_dev(div6, 'class', 'svelte-10edg9u')
...
function create_fragment$3(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(main, 'class', 'svelte-1yy4ltm')
      add_location(main, file$3, 9, 0, 280)
    },
    m: function mount(target, anchor) {
      insert_dev(target, main, anchor)
...
const file$5 = 'src/routes/profile.svelte'
...
function create_fragment$7(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(div0, 'class', 'selected svelte-13uxiwn')
      add_location(div0, file$5, 27, 4, 712)
      attr_dev(div1, 'class', 'svelte-13uxiwn')
      add_location(div1, file$5, 28, 4, 750)
      attr_dev(div2, 'class', 'svelte-13uxiwn')
      add_location(div2, file$5, 29, 4, 774)
      attr_dev(div3, 'id', 'navtray')
      attr_dev(div3, 'class', 'svelte-13uxiwn')
      add_location(div3, file$5, 26, 2, 689)
      attr_dev(div4, 'id', 'container')
      attr_dev(div4, 'class', 'svelte-13uxiwn')
      add_location(div4, file$5, 31, 2, 806)
      attr_dev(div5, 'id', 'profile')
      attr_dev(div5, 'class', 'svelte-13uxiwn')
      add_location(div5, file$5, 20, 0, 540)
    },
    m: function mount(target, anchor) {
