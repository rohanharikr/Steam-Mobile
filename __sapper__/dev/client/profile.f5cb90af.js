import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, a as space, q as create_component, e as element, t as text, r as query_selector_all, f as detach_dev, g as claim_space, u as claim_component, c as claim_element, b as children, h as claim_text, j as attr_dev, l as add_location, m as insert_dev, w as mount_component, n as append_dev, o as set_data_dev, x as transition_in, y as transition_out, z as destroy_component } from './client.69009381.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-11iydj4");
			add_location(img, file, 19, 4, 410);
			attr_dev(h2, "class", "svelte-11iydj4");
			add_location(h2, file, 21, 6, 493);
			attr_dev(h3, "class", "svelte-11iydj4");
			add_location(h3, file, 22, 6, 525);
			attr_dev(div0, "id", "maininfo");
			attr_dev(div0, "class", "svelte-11iydj4");
			add_location(div0, file, 20, 4, 467);
			attr_dev(div1, "id", "top");
			attr_dev(div1, "class", "svelte-11iydj4");
			...
			attr_dev(div5, "class", "svelte-11iydj4");
