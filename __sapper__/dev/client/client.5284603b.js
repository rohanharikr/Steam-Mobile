...
const components = [
	{
		js: () => import('./index.a5e378db.js'),
		css: []
	},
	{
		js: () => import('./profile.5675f24b.js'),
		css: []
	},
	{
		js: () => import('./support.f681483d.js'),
		css: []
	},
	{
		js: () => import('./store.cf19f385.js'),
		css: []
	},
	{
		js: () => import('./chat.f60877a2.js'),
		css: []
	}
];
