...
} from './client.a16bbef8.js'
import { N as Navbar, T as Tabbar } from './Tabbar.96ed9555.js'
import { u as username } from './stores.4f52f55d.js'
...
function create_fragment$3(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      if (img0.src !== (img0_src_value = /*images*/ ctx[0][0]))
        attr_dev(img0, 'src', img0_src_value)
      add_location(img0, file$3, 4, 2, 66)
      if (img1.src !== (img1_src_value = /*images*/ ctx[0][1]))
        attr_dev(img1, 'src', img1_src_value)
      add_location(img1, file$3, 5, 2, 94)
      if (img2.src !== (img2_src_value = /*images*/ ctx[0][2]))
        attr_dev(img2, 'src', img2_src_value)
      add_location(img2, file$3, 6, 2, 122)
      if (img3.src !== (img3_src_value = /*images*/ ctx[0][3]))
        attr_dev(img3, 'src', img3_src_value)
      add_location(img3, file$3, 7, 2, 150)
      if (img4.src !== (img4_src_value = /*images*/ ctx[0][4]))
    ...
    p: function update(ctx, [dirty]) {
      if (
        dirty & /*images*/ 1 &&
        img0.src !== (img0_src_value = /*images*/ ctx[0][0])
      ) {
        attr_dev(img0, 'src', img0_src_value)
      }
      ...
      if (
        dirty & /*images*/ 1 &&
        img1.src !== (img1_src_value = /*images*/ ctx[0][1])
      ) {
        attr_dev(img1, 'src', img1_src_value)
      }
      ...
      if (
        dirty & /*images*/ 1 &&
        img2.src !== (img2_src_value = /*images*/ ctx[0][2])
      ) {
        attr_dev(img2, 'src', img2_src_value)
      }
      ...
      if (
        dirty & /*images*/ 1 &&
        img3.src !== (img3_src_value = /*images*/ ctx[0][3])
      ) {
        attr_dev(img3, 'src', img3_src_value)
      }
      ...
      if (
        dirty & /*images*/ 1 &&
        img4.src !== (img4_src_value = /*images*/ ctx[0][4])
      ) {
        attr_dev(img4, 'src', img4_src_value)
      }
    },
...
function instance$3($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$')
      console.warn(`<BadgeShowcase> was created with unknown prop '${key}'`)
  })
...
class BadgeShowcase extends SvelteComponentDev {
  ...
  get images() {
    throw new Error(
      "<BadgeShowcase>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'"
    )
  }

  set images(value) {
    throw new Error(
      "<BadgeShowcase>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'"
    )
  }
}
...
function instance$4($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$')
      console.warn(`<Badges> was created with unknown prop '${key}'`)
  })
