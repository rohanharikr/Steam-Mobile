...
} from './client.e7c13e0e.js'
import { N as Navbar, T as Tabbar } from './Tabbar.93b9bbd0.js'
...
function create_if_block_1$1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(ul, 'class', 'svelte-1xjm7jk')
