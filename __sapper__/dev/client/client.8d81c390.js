...
const components = [
	{
		js: () => import('./index.e80c2316.js'),
		css: []
	},
	{
		js: () => import('./profile.a32bcdba.js'),
		css: []
	},
	{
		js: () => import('./support.f286aab1.js'),
		css: []
	},
	{
		js: () => import('./store.5bc60bc5.js'),
		css: []
	},
	{
		js: () => import('./chat.eea4e0f9.js'),
		css: []
	}
];
