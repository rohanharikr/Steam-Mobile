...
function instance$4($$self, $$props, $$invalidate) {
	let { name } = $$props,
		{ number } = $$props,
		{ id } = $$props,
		{ showcaseImages } = $$props;

	const writable_props = ["name", "number", "id", "showcaseImages"];
	...
	$$self.$set = $$props => {
		...
		if ("showcaseImages" in $$props) $$invalidate(3, showcaseImages = $$props.showcaseImages);
	};
	...
	return [name, number, id, showcaseImages];
}
...
class ProfileTile extends SvelteComponentDev {
	constructor(options) {
		...
		if (/*showcaseImages*/ ctx[3] === undefined && !("showcaseImages" in props)) {
			console.warn("<ProfileTile> was created without expected prop 'showcaseImages'");
		}
	}
