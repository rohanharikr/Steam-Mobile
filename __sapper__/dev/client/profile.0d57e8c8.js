...
} from './client.2ed50a93.js'
import { N as Navbar, T as Tabbar } from './Tabbar.ef77efb4.js'
import { u as username } from './stores.e81863c4.js'
...
function instance$5($$self, $$props) {
  ...
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$')
      console.warn(`<Friends> was created with unknown prop '${key}'`)
  })
