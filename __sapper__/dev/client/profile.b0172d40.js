...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img0, file$3, 6, 2, 114);
			...
			add_location(img3, file$3, 9, 2, 263);
			...
			add_location(img4, file$3, 10, 2, 320);
			attr_dev(div, "id", "badgeshowcase");
			attr_dev(div, "class", "svelte-soube2");
			add_location(div, file$3, 5, 0, 87);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, img0);
