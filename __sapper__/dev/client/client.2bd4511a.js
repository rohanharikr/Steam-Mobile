...
const components = [
	{
		js: () => import('./index.abaed941.js'),
		css: []
	},
	{
		js: () => import('./profile.4b6e44ad.js'),
		css: []
	},
	{
		js: () => import('./support.90a0e9bd.js'),
		css: []
	},
	{
		js: () => import('./store.70efbc71.js'),
		css: []
	},
	{
		js: () => import('./chat.f1b8f2ef.js'),
		css: []
	}
];
