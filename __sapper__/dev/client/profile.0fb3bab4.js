import {
  ...
  U as onDestroy,
  V as assign,
  W as exclude_internal_props,
  X as empty,
  Y as get_spread_update,
  Z as get_spread_object,
  C as createEventDispatcher,
  _ as set_attributes,
  F as listen_dev,
  r as query_selector_all,
} from './client.c58a181a.js'
import { N as Navbar, T as Tabbar } from './Tabbar.c614431f.js'
import { u as username } from './stores.ab9c1067.js'
...
function instance$1($$self, $$props) {
  ...
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$')
      console.warn(`<AboutMeTile> was created with unknown prop '${key}'`)
  })
  ...
  const block = {
    ...
    h: function hydrate() {
      if (
        img.src !==
        (img_src_value =
          'https://steamcommunity-a.akamaihd.net/public/images/badges/02_years/steamyears5_54.png')
      )
...
function instance$2($$self, $$props) {
  ...
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$')
      console.warn(`<MainBadge> was created with unknown prop '${key}'`)
  })
...
function create_fragment$3(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      if (img0.src !== (img0_src_value = /*images*/ ctx[0][0].link))
        attr_dev(img0, 'src', img0_src_value)
      set_style(img0, 'height', '32px')
      attr_dev(img0, 'class', 'svelte-soube2')
      add_location(img0, file$3, 5, 2, 104)
      if (img1.src !== (img1_src_value = /*images*/ ctx[0][1].link))
        attr_dev(img1, 'src', img1_src_value)
      set_style(img1, 'height', '32px')
      attr_dev(img1, 'class', 'svelte-soube2')
      add_location(img1, file$3, 6, 2, 159)
      if (img2.src !== (img2_src_value = /*images*/ ctx[0][2].link))
        attr_dev(img2, 'src', img2_src_value)
      attr_dev(img2, 'class', 'svelte-soube2')
      add_location(img2, file$3, 7, 2, 214)
      if (img3.src !== (img3_src_value = /*images*/ ctx[0][3].link))
        attr_dev(img3, 'src', img3_src_value)
      set_style(img3, 'height', '36px')
      attr_dev(img3, 'class', 'svelte-soube2')
      add_location(img3, file$3, 8, 2, 247)
      if (img4.src !== (img4_src_value = /*images*/ ctx[0][4].link))
        attr_dev(img4, 'src', img4_src_value)
      set_style(img4, 'height', '38px')
      attr_dev(img4, 'class', 'svelte-soube2')
      add_location(img4, file$3, 9, 2, 302)
      attr_dev(div, 'id', 'badgeshowcase')
      attr_dev(div, 'class', 'svelte-soube2')
      add_location(div, file$3, 4, 0, 77)
    },
    m: function mount(target, anchor) {
      insert_dev(target, div, anchor)
      append_dev(div, img0)
    ...
    p: function update(ctx, [dirty]) {
      if (
        dirty & /*images*/ 1 &&
        img0.src !== (img0_src_value = /*images*/ ctx[0][0].link)
      ) {
        attr_dev(img0, 'src', img0_src_value)
      }
      ...
      if (
        dirty & /*images*/ 1 &&
        img1.src !== (img1_src_value = /*images*/ ctx[0][1].link)
      ) {
        attr_dev(img1, 'src', img1_src_value)
      }
      ...
      if (
        dirty & /*images*/ 1 &&
        img2.src !== (img2_src_value = /*images*/ ctx[0][2].link)
      ) {
        attr_dev(img2, 'src', img2_src_value)
      }
      ...
      if (
        dirty & /*images*/ 1 &&
        img3.src !== (img3_src_value = /*images*/ ctx[0][3].link)
      ) {
        attr_dev(img3, 'src', img3_src_value)
      }
      ...
      if (
        dirty & /*images*/ 1 &&
        img4.src !== (img4_src_value = /*images*/ ctx[0][4].link)
      ) {
        attr_dev(img4, 'src', img4_src_value)
      }
    },
...
function instance$3($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$')
      console_1.warn(`<Showcase> was created with unknown prop '${key}'`)
  })
...
class Showcase extends SvelteComponentDev {
  ...
  get images() {
    throw new Error(
      "<Showcase>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'"
    )
  }

  set images(value) {
    throw new Error(
      "<Showcase>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'"
    )
  }
}
...
function instance$4($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$')
      console_1$1.warn(`<ProfileTile> was created with unknown prop '${key}'`)
  })
...
class ProfileTile extends SvelteComponentDev {
  constructor(options) {
    ...
    if (/*name*/ ctx[0] === undefined && !('name' in props)) {
      console_1$1.warn("<ProfileTile> was created without expected prop 'name'")
    }

    if (/*number*/ ctx[1] === undefined && !('number' in props)) {
      console_1$1.warn(
        "<ProfileTile> was created without expected prop 'number'"
      )
    }

    if (/*id*/ ctx[2] === undefined && !('id' in props)) {
      console_1$1.warn("<ProfileTile> was created without expected prop 'id'")
    }

    if (/*images*/ ctx[3] === undefined && !('images' in props)) {
      console_1$1.warn(
        "<ProfileTile> was created without expected prop 'images'"
      )
    }
  }
  ...
  get name() {
    throw new Error(
      "<ProfileTile>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'"
    )
  }

  set name(value) {
    throw new Error(
      "<ProfileTile>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'"
    )
  }
  ...
  const profiletile2 = new ProfileTile({
    props: {
      ...
      images: [
        {
          link:
            'https://steamcommunity-a.akamaihd.net/public/images/badges/37_summer2019/level25_80.png',
        },
        {
          link:
            'https://steamcdn-a.akamaihd.net/steamcommunity/public/images/items/730/54e40b9e2288fbab8bd4c6537b0325d405c7e1b0.png',
        },
        {
          link:
            'https://steamcommunity-a.akamaihd.net/public/images/badges/28_springcleaning2018/bronze_80.png',
        },
        {
          link:
            'https://steamcdn-a.akamaihd.net/steamcommunity/public/images/items/762800/d467ec8eaed4643c47fbed43ed781daef2525963.png',
        },
        {
          link:
            'https://steamcommunity-a.akamaihd.net/public/images/badges/27_steamawardnominations/level04_80.png',
        },
      ],
    },
    $$inline: true,
...
const file$6 =
  'Users/rohanharikumar/node_modules/svelte-routing/src/Link.svelte'
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
