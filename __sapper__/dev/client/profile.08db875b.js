...
} from './client.32ced06a.js'
import { N as Navbar, T as Tabbar } from './Tabbar.9f62a716.js'
import { u as username } from './stores.0abb59ac.js'
...
function create_fragment$4(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(div0, 'class', 'svelte-1m7z1ha')
      add_location(div0, file$4, 8, 2, 153)
      attr_dev(div1, 'id', /*id*/ ctx[2])
      attr_dev(div1, 'class', 'svelte-1m7z1ha')
