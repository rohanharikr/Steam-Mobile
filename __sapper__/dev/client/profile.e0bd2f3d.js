...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			if (img0.src !== (img0_src_value = /*showcase*/ ctx[0][0].link)) attr_dev(img0, "src", img0_src_value);
			set_style(img0, "height", "32px");
			attr_dev(img0, "class", "svelte-soube2");
			add_location(img0, file$3, 6, 2, 116);
			if (img1.src !== (img1_src_value = /*showcase*/ ctx[0][1].link)) attr_dev(img1, "src", img1_src_value);
			set_style(img1, "height", "32px");
			attr_dev(img1, "class", "svelte-soube2");
			add_location(img1, file$3, 7, 2, 173);
			if (img2.src !== (img2_src_value = /*showcase*/ ctx[0][2].link)) attr_dev(img2, "src", img2_src_value);
			attr_dev(img2, "class", "svelte-soube2");
			add_location(img2, file$3, 8, 2, 230);
			if (img3.src !== (img3_src_value = /*showcase*/ ctx[0][3].link)) attr_dev(img3, "src", img3_src_value);
			set_style(img3, "height", "36px");
			attr_dev(img3, "class", "svelte-soube2");
			add_location(img3, file$3, 9, 2, 265);
			if (img4.src !== (img4_src_value = /*showcase*/ ctx[0][4].link)) attr_dev(img4, "src", img4_src_value);
			set_style(img4, "height", "38px");
			attr_dev(img4, "class", "svelte-soube2");
			add_location(img4, file$3, 10, 2, 322);
			attr_dev(div, "id", "badgeshowcase");
			attr_dev(div, "class", "svelte-soube2");
			add_location(div, file$3, 5, 0, 89);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, img0);
...
function instance$3($$self, $$props, $$invalidate) {
	...
	$$self.$capture_state = () => ({ images, showcase });

	$$self.$inject_state = $$props => {
		if ("images" in $$props) $$invalidate(1, images = $$props.images);
		if ("showcase" in $$props) $$invalidate(0, showcase = $$props.showcase);
	};
...
class Showcase extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance$3, create_fragment$3, safe_not_equal, { images: 1 });
