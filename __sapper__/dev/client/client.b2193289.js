...
const components = [
	{
		js: () => import('./index.c76cfd84.js'),
		css: []
	},
	{
		js: () => import('./profile.18bc15df.js'),
		css: []
	},
	{
		js: () => import('./support.4b02cf44.js'),
		css: []
	},
	{
		js: () => import('./store.7a9ffb7e.js'),
		css: []
	},
	{
		js: () => import('./chat.f1246e33.js'),
		css: []
	}
];
