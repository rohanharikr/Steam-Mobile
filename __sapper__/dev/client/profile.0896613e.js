...
} from './client.be0d70c3.js'
import { N as Navbar, T as Tabbar } from './Tabbar.86eb1821.js'
import { u as username } from './stores.337e36c0.js'
...
function create_fragment$4(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      add_location(h3, file$4, 9, 4, 174)
      add_location(h2, file$4, 10, 4, 194)
      attr_dev(div0, 'id', 'title')
      attr_dev(div0, 'class', 'svelte-t8bt5s')
      add_location(div0, file$4, 8, 2, 153)
      attr_dev(div1, 'id', /*id*/ ctx[2])
      attr_dev(div1, 'class', 'svelte-t8bt5s')
      add_location(div1, file$4, 7, 0, 140)
    },
    m: function mount(target, anchor) {
      insert_dev(target, div1, anchor)
      append_dev(div1, div0)
