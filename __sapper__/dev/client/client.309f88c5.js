...
const components = [
	{
		js: () => import('./index.c75f6af3.js'),
		css: []
	},
	{
		js: () => import('./profile.dda64e1e.js'),
		css: []
	},
	{
		js: () => import('./support.87b5193e.js'),
		css: []
	},
	{
		js: () => import('./store.f1f8a76e.js'),
		css: []
	},
	{
		js: () => import('./chat.efeaf4f7.js'),
		css: []
	}
];
