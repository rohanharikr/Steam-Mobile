...
function create_fragment$5(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h2, file$5, 3, 4, 62);
			attr_dev(div0, "id", "title");
			attr_dev(div0, "class", "svelte-1ura4zm");
			add_location(div0, file$5, 1, 2, 21);
			attr_dev(div1, "id", "friends");
			attr_dev(div1, "class", "svelte-1ura4zm");
