import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, e as element, a as space, t as text, c as claim_element, g as claim_space, h as claim_text, j as attr_dev, k as set_style, l as add_location, m as insert_dev, o as set_data_dev, p as noop, f as detach_dev, b as children, n as append_dev, q as create_component, u as claim_component, w as mount_component, x as transition_in, y as transition_out, z as destroy_component, K as group_outros, L as check_outros, M as globals, r as query_selector_all } from './client.2bd4511a.js';
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h5, file$2, 24, 2, 681);
			attr_dev(div, "id", "support");
			attr_dev(div, "class", "svelte-1pwsucv");
			add_location(div, file$2, 20, 0, 510);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
...
function fetchAvatarUrl() {
	return fetch("https://api.github.com/repos/rohanharikr/Steam-Mobile/commits").then(response => response.json()).then(data => console.log(data));
}
