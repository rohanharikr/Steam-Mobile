import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, e as element, a as space, t as text, c as claim_element, b as children, f as detach_dev, g as claim_space, h as claim_text, j as attr_dev, l as add_location, k as set_style, m as insert_dev, n as append_dev, o as set_data_dev, p as noop, K as group_outros, y as transition_out, L as check_outros, x as transition_in, q as create_component, u as claim_component, w as mount_component, z as destroy_component, F as listen_dev, r as query_selector_all } from './client.5470ae18.js';
import { N as Navbar, T as Tabbar } from './Tabbar.acc54689.js';
import { u as username } from './stores.9e96245c.js';
...
function create_fragment$5(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			var div_nodes = children(div);
			t0 = claim_text(div_nodes, /*count*/ ctx[1]);
			div_nodes.forEach(detach_dev);
		...
		h: function hydrate() {
			attr_dev(div, "class", "count svelte-1aj5t8y");
			add_location(div, file$5, 13, 0, 177);
			if (img.src !== (img_src_value = /*update*/ ctx[0] ? "like.svg" : "likeidle.svg")) attr_dev(img, "src", img_src_value);
			add_location(img, file$5, 14, 10, 220);
		},
		m: function mount(target, anchor, remount) {
			...
			if (remount) dispose();
			dispose = listen_dev(img, "click", /*likeUnlike*/ ctx[2], false, false, false);
		},
		p: function update(ctx, [dirty]) {
...
function instance$5($$self, $$props, $$invalidate) {
	...
	$$self.$capture_state = () => ({ update, count, likeUnlike });
	...
	return [update, count, likeUnlike];
}
