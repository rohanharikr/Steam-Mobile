...
function instance$4($$self, $$props, $$invalidate) {
	...
	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<ProfileTile> was created with unknown prop '${key}'`);
	});
...
class ProfileTile extends SvelteComponentDev {
	constructor(options) {
		...
		if (/*name*/ ctx[0] === undefined && !("name" in props)) {
			console_1.warn("<ProfileTile> was created without expected prop 'name'");
		}

		if (/*number*/ ctx[1] === undefined && !("number" in props)) {
			console_1.warn("<ProfileTile> was created without expected prop 'number'");
		}

		if (/*id*/ ctx[2] === undefined && !("id" in props)) {
			console_1.warn("<ProfileTile> was created without expected prop 'id'");
		}

		if (/*images*/ ctx[3] === undefined && !("images" in props)) {
			console_1.warn("<ProfileTile> was created without expected prop 'images'");
		}
	}
