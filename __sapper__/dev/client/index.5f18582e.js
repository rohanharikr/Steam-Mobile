...
import { u as username } from './stores.de372ef1.js'
...
function create_fragment(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(div0, 'class', 'timerbar svelte-teka7o')
