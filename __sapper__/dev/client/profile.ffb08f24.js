...
function create_fragment$4(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div0, "class", "svelte-7skqnx");
			add_location(div0, file$4, 8, 2, 153);
			attr_dev(div1, "id", /*id*/ ctx[2]);
			attr_dev(div1, "class", "svelte-7skqnx");
