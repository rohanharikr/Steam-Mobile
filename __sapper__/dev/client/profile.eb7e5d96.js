...
} from './client.42f8c2a9.js'
import { N as Navbar, T as Tabbar } from './Tabbar.6a60fc0f.js'
import { u as username } from './stores.277beae8.js'
...
function create_fragment$2(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(div0, 'class', 'svelte-10nlb6c')
      add_location(div0, file$2, 2, 2, 126)
      attr_dev(div1, 'id', 'badgemain')
      attr_dev(div1, 'class', 'svelte-10nlb6c')
