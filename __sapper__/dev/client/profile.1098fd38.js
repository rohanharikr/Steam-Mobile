...
} from './client.04a13563.js'
import { N as Navbar, T as Tabbar } from './Tabbar.0c87c762.js'
import { u as username } from './stores.a3957572.js'
...
function create_fragment$4(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      add_location(h3, file$4, 9, 4, 177)
      add_location(h2, file$4, 10, 4, 197)
      attr_dev(div0, 'id', 'title')
      attr_dev(div0, 'class', 'svelte-1ye7e9i')
      add_location(div0, file$4, 8, 2, 156)
      attr_dev(div1, 'id', 'badges')
      attr_dev(div1, 'class', 'svelte-1ye7e9i')
      add_location(div1, file$4, 7, 0, 136)
    },
    m: function mount(target, anchor) {
      insert_dev(target, div1, anchor)
      append_dev(div1, div0)
...
function instance$4($$self, $$props, $$invalidate) {
  ...
  $$self.$capture_state = () => ({ MainBadge, Showcase, name, number })
