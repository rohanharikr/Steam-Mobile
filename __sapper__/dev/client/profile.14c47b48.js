...
} from './client.847aad34.js'
import { N as Navbar, T as Tabbar } from './Tabbar.5fd328ac.js'
import { u as username } from './stores.e7e21fbd.js'
...
function create_fragment$3(ctx) {
  ...
  const block = {
    ...
    l: function claim(nodes) {
      ...
      div0_nodes.forEach(detach_dev)
      t3 = claim_space(div2_nodes)
      claim_component(mainbadge.$$.fragment, div2_nodes)
    ...
    h: function hydrate() {
      add_location(h3, file$3, 6, 2, 102)
      add_location(h2, file$3, 7, 2, 120)
      attr_dev(div0, 'id', 'title')
      attr_dev(div0, 'class', 'svelte-1ewvems')
      add_location(div0, file$3, 5, 1, 83)
      attr_dev(div1, 'id', 'badges')
      attr_dev(div1, 'class', 'svelte-1ewvems')
      add_location(div1, file$3, 10, 1, 155)
      attr_dev(div2, 'id', 'badges')
      attr_dev(div2, 'class', 'svelte-1ewvems')
    ...
    m: function mount(target, anchor) {
      ...
      append_dev(h2, t2)
      append_dev(div2, t3)
      mount_component(mainbadge, div2, null)
      append_dev(div2, t4)
