...
let username = writable('bingotheslayer');
// export let name = writable('Rohan Harikumar')
// export let level = writable('40')
// export let profilepicture = writable('profilepicture.jpg')
// export let description = writable('Hidetaka Miyazaki is god. Change my mind. Dank Souls has the best lore in any videogame. Waiting for Elden Ring.')
...
const Navbar = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${validate_component(Headroom, "Headroom").$$render($$result, { offset: 50, tolerance: 5 }, {}, {
		default: () => `<div id="${"navbar"}" class="${"svelte-13oo9il"}"><img src="${"steambrand.svg"}" height="${"28px"}" style="${"opacity: 1"}">
...
const css$3 = {
	code: "#guard.svelte-1w0j7dt{padding:0px 30px;padding-bottom:60px;text-align:center}",
	map: "{\"version\":3,\"file\":\"index.svelte\",\"sources\":[\"index.svelte\"],\"sourcesContent\":[\"<script>\\n  import Navbar from '../components/Navbar.svelte'\\n  import Tabbar from '../components/Tabbar.svelte'\\n  import SteamGuard from '../components/SteamGuard.svelte'\\n  import SteamMusic from '../components/SteamMusic.svelte'\\n</script>\\n\\n<svelte:head>\\n  <title>Guard :: Steam Mobile</title>\\n</svelte:head>\\n\\n<Navbar title=\\\"Guard\\\" />\\n<div id=\\\"guard\\\">\\n  <SteamGuard />\\n  <SteamMusic />\\n</div>\\n<Tabbar location={3} />\\n\\n<style>\\n  #guard {\\n    padding: 0px 30px;\\n    padding-bottom: 60px;\\n    text-align: center;\\n  }\\n</style>\\n\"],\"names\":[],\"mappings\":\"AAmBE,MAAM,eAAC,CAAC,AACN,OAAO,CAAE,GAAG,CAAC,IAAI,CACjB,cAAc,CAAE,IAAI,CACpB,UAAU,CAAE,MAAM,AACpB,CAAC\"}"
};
...
<div id="${"guard"}" class="${"svelte-1w0j7dt"}">${validate_component(SteamGuard, "SteamGuard").$$render($$result, {}, {}, {})}
...
const css$4 = {
	code: "#head.svelte-15zeztu{position:relative}#userinfo.svelte-15zeztu{margin-left:18px}#level.svelte-15zeztu{margin-left:auto;font-size:16px;font-weight:300;border:2px solid #467a3c;border-radius:50%;margin-bottom:12px;width:35px;height:35px;display:flex;justify-content:center;align-items:center}h3.svelte-15zeztu{font-size:20px;font-weight:500;line-height:1}h5.svelte-15zeztu{font-size:14px;font-weight:300;line-height:1;color:#696969}#profilepicture.svelte-15zeztu{background-size:cover;background-repeat:no-repeat;height:75px;width:75px;border-radius:2px}#layer1.svelte-15zeztu{position:absolute;height:50px;background:linear-gradient(to top, rgb(0, 0, 0), rgba(0, 0, 0, 0));bottom:0;width:100%;z-index:975}#contentwrapper.svelte-15zeztu{position:absolute;z-index:99;width:100%}#content.svelte-15zeztu{padding:30px;display:flex;align-items:center}#layer2.svelte-15zeztu{background-size:cover;width:100%;height:140px;background-repeat:no-repeat;z-index:3;position:relative;opacity:0.1}#layer3.svelte-15zeztu{background:#0f0b20;height:140px;width:100%;position:absolute;top:0;z-index:2}",
	map: "{\"version\":3,\"file\":\"ProfileHeader.svelte\",\"sources\":[\"ProfileHeader.svelte\"],\"sourcesContent\":[\"<script>\\n  export let alias, name, profilepicture, level\\n</script>\\n\\n<main>\\n  <div id=\\\"head\\\">\\n    <div id=\\\"layer1\\\" />\\n    <div id=\\\"contentwrapper\\\">\\n      <div id=\\\"content\\\">\\n        <div\\n          id=\\\"profilepicture\\\"\\n          style=\\\"background-image: url({profilepicture});\\\" />\\n        <div id=\\\"userinfo\\\">\\n          <h3>{alias}</h3>\\n          <h5>{name}</h5>\\n        </div>\\n        <!-- need to right logic for handling badge color -->\\n        <div id=\\\"level\\\">{level}</div>\\n        <!-- need to right logic for handling badge color -->\\n      </div>\\n    </div>\\n    <div id=\\\"layer2\\\" style=\\\"background-image: url(gta.jpg);\\\" />\\n    <div id=\\\"layer3\\\" />\\n  </div>\\n</main>\\n\\n<style>\\n  #head {\\n    position: relative;\\n  }\\n\\n  #userinfo {\\n    margin-left: 18px;\\n  }\\n\\n  #level {\\n    margin-left: auto;\\n    font-size: 16px;\\n    font-weight: 300;\\n    border: 2px solid #467a3c;\\n    border-radius: 50%;\\n    margin-bottom: 12px;\\n    width: 35px;\\n    height: 35px;\\n    display: flex;\\n    justify-content: center;\\n    align-items: center;\\n  }\\n\\n  h3 {\\n    font-size: 20px;\\n    font-weight: 500;\\n    line-height: 1;\\n  }\\n\\n  h5 {\\n    font-size: 14px;\\n    font-weight: 300;\\n    line-height: 1;\\n    color: #696969;\\n  }\\n\\n  #profilepicture {\\n    background-size: cover;\\n    background-repeat: no-repeat;\\n    height: 75px;\\n    width: 75px;\\n    border-radius: 2px;\\n  }\\n\\n  #layer1 {\\n    position: absolute;\\n    height: 50px;\\n    background: linear-gradient(to top, rgb(0, 0, 0), rgba(0, 0, 0, 0));\\n    bottom: 0;\\n    width: 100%;\\n    z-index: 975;\\n  }\\n\\n  #contentwrapper {\\n    position: absolute;\\n    z-index: 99;\\n    width: 100%;\\n  }\\n\\n  #content {\\n    padding: 30px;\\n    display: flex;\\n    align-items: center;\\n  }\\n\\n  #layer2 {\\n    background-size: cover;\\n    width: 100%;\\n    height: 140px;\\n    background-repeat: no-repeat;\\n    z-index: 3;\\n    position: relative;\\n    opacity: 0.1;\\n  }\\n\\n  #layer3 {\\n    background: #0f0b20;\\n    height: 140px;\\n    width: 100%;\\n    position: absolute;\\n    top: 0;\\n    z-index: 2;\\n  }\\n</style>\\n\"],\"names\":[],\"mappings\":\"AA2BE,KAAK,eAAC,CAAC,AACL,QAAQ,CAAE,QAAQ,AACpB,CAAC,AAED,SAAS,eAAC,CAAC,AACT,WAAW,CAAE,IAAI,AACnB,CAAC,AAED,MAAM,eAAC,CAAC,AACN,WAAW,CAAE,IAAI,CACjB,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,GAAG,CAChB,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,OAAO,CACzB,aAAa,CAAE,GAAG,CAClB,aAAa,CAAE,IAAI,CACnB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,MAAM,CACvB,WAAW,CAAE,MAAM,AACrB,CAAC,AAED,EAAE,eAAC,CAAC,AACF,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,GAAG,CAChB,WAAW,CAAE,CAAC,AAChB,CAAC,AAED,EAAE,eAAC,CAAC,AACF,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,GAAG,CAChB,WAAW,CAAE,CAAC,CACd,KAAK,CAAE,OAAO,AAChB,CAAC,AAED,eAAe,eAAC,CAAC,AACf,eAAe,CAAE,KAAK,CACtB,iBAAiB,CAAE,SAAS,CAC5B,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,IAAI,CACX,aAAa,CAAE,GAAG,AACpB,CAAC,AAED,OAAO,eAAC,CAAC,AACP,QAAQ,CAAE,QAAQ,CAClB,MAAM,CAAE,IAAI,CACZ,UAAU,CAAE,gBAAgB,EAAE,CAAC,GAAG,CAAC,CAAC,IAAI,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CACnE,MAAM,CAAE,CAAC,CACT,KAAK,CAAE,IAAI,CACX,OAAO,CAAE,GAAG,AACd,CAAC,AAED,eAAe,eAAC,CAAC,AACf,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,EAAE,CACX,KAAK,CAAE,IAAI,AACb,CAAC,AAED,QAAQ,eAAC,CAAC,AACR,OAAO,CAAE,IAAI,CACb,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,AACrB,CAAC,AAED,OAAO,eAAC,CAAC,AACP,eAAe,CAAE,KAAK,CACtB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,KAAK,CACb,iBAAiB,CAAE,SAAS,CAC5B,OAAO,CAAE,CAAC,CACV,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,GAAG,AACd,CAAC,AAED,OAAO,eAAC,CAAC,AACP,UAAU,CAAE,OAAO,CACnB,MAAM,CAAE,KAAK,CACb,KAAK,CAAE,IAAI,CACX,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,CAAC,CACN,OAAO,CAAE,CAAC,AACZ,CAAC\"}"
};
...
const ProfileHeader = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	if ($$props.alias === void 0 && $$bindings.alias && alias !== void 0) $$bindings.alias(alias);
	if ($$props.name === void 0 && $$bindings.name && name !== void 0) $$bindings.name(name);
	if ($$props.profilepicture === void 0 && $$bindings.profilepicture && profilepicture !== void 0) $$bindings.profilepicture(profilepicture);
	if ($$props.level === void 0 && $$bindings.level && level !== void 0) $$bindings.level(level);
	$$result.css.add(css$4);

	return `<main><div id="${"head"}" class="${"svelte-15zeztu"}"><div id="${"layer1"}" class="${"svelte-15zeztu"}"></div>
    <div id="${"contentwrapper"}" class="${"svelte-15zeztu"}"><div id="${"content"}" class="${"svelte-15zeztu"}"><div id="${"profilepicture"}" style="${"background-image: url(" + escape(profilepicture) + ");"}" class="${"svelte-15zeztu"}"></div>
        <div id="${"userinfo"}" class="${"svelte-15zeztu"}"><h3 class="${"svelte-15zeztu"}">${escape(alias)}</h3>
          <h5 class="${"svelte-15zeztu"}">${escape(name)}</h5></div>
        
        <div id="${"level"}" class="${"svelte-15zeztu"}">${escape(level)}</div>
        </div></div>
    <div id="${"layer2"}" style="${"background-image: url(gta.jpg);"}" class="${"svelte-15zeztu"}"></div>
    <div id="${"layer3"}" class="${"svelte-15zeztu"}"></div></div>
</main>`;
});
...
const css$5 = {
	code: "#aboutme.svelte-r6lw0a{background-color:#0f0b20;padding:10px 15px;border-radius:2px;font-size:14px;line-height:18px;font-weight:300;display:flex;align-items:center;grid-column:1/3;min-height:38px}",
	map: "{\"version\":3,\"file\":\"AboutMeTile.svelte\",\"sources\":[\"AboutMeTile.svelte\"],\"sourcesContent\":[\"<div id=\\\"aboutme\\\">\\n  Hidetaka Miyazaki is god. Change my mind. Dank Souls has the best lore in any\\n  videogame. Waiting for Elden Ring.\\n</div>\\n\\n<style>\\n  #aboutme {\\n    background-color: #0f0b20;\\n    padding: 10px 15px;\\n    border-radius: 2px;\\n    font-size: 14px;\\n    line-height: 18px;\\n    font-weight: 300;\\n    display: flex;\\n    align-items: center;\\n    grid-column: 1/3;\\n    min-height: 38px;\\n  }\\n</style>\\n\"],\"names\":[],\"mappings\":\"AAME,QAAQ,cAAC,CAAC,AACR,gBAAgB,CAAE,OAAO,CACzB,OAAO,CAAE,IAAI,CAAC,IAAI,CAClB,aAAa,CAAE,GAAG,CAClB,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,IAAI,CACjB,WAAW,CAAE,GAAG,CAChB,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,WAAW,CAAE,CAAC,CAAC,CAAC,CAChB,UAAU,CAAE,IAAI,AAClB,CAAC\"}"
};

const AboutMeTile = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	$$result.css.add(css$5);

	return `<div id="${"aboutme"}" class="${"svelte-r6lw0a"}">Hidetaka Miyazaki is god. Change my mind. Dank Souls has the best lore in any
  videogame. Waiting for Elden Ring.
</div>`;
});
...
const css$6 = {
	code: "#badgemain.svelte-m45iuk{background-color:#161c2d;border-radius:2px;padding:10px;display:flex;align-items:center;margin-bottom:24px}#badgemaininfo.svelte-m45iuk{display:flex;flex-direction:column;margin-left:18px}h2.svelte-m45iuk{font-size:16px;font-weight:300;line-height:1}h4.svelte-m45iuk{font-size:12px;line-height:1;text-transform:uppercase;color:#9c9c9c}",
	map: "{\"version\":3,\"file\":\"MainBadge.svelte\",\"sources\":[\"MainBadge.svelte\"],\"sourcesContent\":[\"<div id=\\\"badgemain\\\">\\n  <img\\n    src=\\\"https://steamcommunity-a.akamaihd.net/public/images/badges/02_years/steamyears5_54.png\\\" />\\n  <div id=\\\"badgemaininfo\\\">\\n    <h2>Years of Service</h2>\\n    <h4>250 XP</h4>\\n  </div>\\n</div>\\n\\n<style>\\n  #badgemain {\\n    background-color: #161c2d;\\n    border-radius: 2px;\\n    padding: 10px;\\n    display: flex;\\n    align-items: center;\\n    margin-bottom: 24px;\\n  }\\n\\n  #badgemaininfo {\\n    display: flex;\\n    flex-direction: column;\\n    margin-left: 18px;\\n  }\\n\\n  h2 {\\n    font-size: 16px;\\n    font-weight: 300;\\n    line-height: 1;\\n  }\\n\\n  h4 {\\n    font-size: 12px;\\n    line-height: 1;\\n    text-transform: uppercase;\\n    color: #9c9c9c;\\n  }\\n</style>\\n\"],\"names\":[],\"mappings\":\"AAUE,UAAU,cAAC,CAAC,AACV,gBAAgB,CAAE,OAAO,CACzB,aAAa,CAAE,GAAG,CAClB,OAAO,CAAE,IAAI,CACb,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,aAAa,CAAE,IAAI,AACrB,CAAC,AAED,cAAc,cAAC,CAAC,AACd,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,WAAW,CAAE,IAAI,AACnB,CAAC,AAED,EAAE,cAAC,CAAC,AACF,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,GAAG,CAChB,WAAW,CAAE,CAAC,AAChB,CAAC,AAED,EAAE,cAAC,CAAC,AACF,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,CAAC,CACd,cAAc,CAAE,SAAS,CACzB,KAAK,CAAE,OAAO,AAChB,CAAC\"}"
};

const MainBadge = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	$$result.css.add(css$6);

	return `<div id="${"badgemain"}" class="${"svelte-m45iuk"}"><img src="${"https://steamcommunity-a.akamaihd.net/public/images/badges/02_years/steamyears5_54.png"}">
  <div id="${"badgemaininfo"}" class="${"svelte-m45iuk"}"><h2 class="${"svelte-m45iuk"}">Years of Service</h2>
    <h4 class="${"svelte-m45iuk"}">250 XP</h4></div>
</div>`;
});
...
const css$7 = {
	code: "#badgeshowcase.svelte-dgsgwc img.svelte-dgsgwc{height:40px}#badgeshowcase.svelte-dgsgwc.svelte-dgsgwc{display:flex;justify-content:space-between;align-items:center}",
	map: "{\"version\":3,\"file\":\"Showcase.svelte\",\"sources\":[\"Showcase.svelte\"],\"sourcesContent\":[\"<script>\\n  export let images\\n</script>\\n\\n<div id=\\\"badgeshowcase\\\">\\n  <img src={images[0].link} style=\\\"height: 32px;\\\" />\\n  <img src={images[1].link} style=\\\"height: 32px;\\\" />\\n  <img src={images[2].link} />\\n  <img src={images[3].link} style=\\\"height: 36px;\\\" />\\n  <img src={images[4].link} style=\\\"height: 38px;\\\" />\\n</div>\\n\\n<style>\\n  #badgeshowcase img {\\n    height: 40px;\\n  }\\n\\n  #badgeshowcase {\\n    display: flex;\\n    justify-content: space-between;\\n    align-items: center;\\n  }\\n</style>\\n\"],\"names\":[],\"mappings\":\"AAaE,4BAAc,CAAC,GAAG,cAAC,CAAC,AAClB,MAAM,CAAE,IAAI,AACd,CAAC,AAED,cAAc,4BAAC,CAAC,AACd,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,aAAa,CAC9B,WAAW,CAAE,MAAM,AACrB,CAAC\"}"
};
...
const Showcase = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div id="${"badgeshowcase"}" class="${"svelte-dgsgwc"}"><img${add_attribute("src", images[0].link, 0)} style="${"height: 32px;"}" class="${"svelte-dgsgwc"}">
  <img${add_attribute("src", images[1].link, 0)} style="${"height: 32px;"}" class="${"svelte-dgsgwc"}">
  <img${add_attribute("src", images[2].link, 0)} class="${"svelte-dgsgwc"}">
  <img${add_attribute("src", images[3].link, 0)} style="${"height: 36px;"}" class="${"svelte-dgsgwc"}">
  <img${add_attribute("src", images[4].link, 0)} style="${"height: 38px;"}" class="${"svelte-dgsgwc"}">
</div>`;
});
...
const css$8 = {
	code: "#title.svelte-v3egmx{justify-content:space-between;display:flex;margin-bottom:10px}h2.svelte-v3egmx{font-weight:500;color:#027aff}#badges.svelte-v3egmx,#friends.svelte-v3egmx,#groups.svelte-v3egmx{background-color:#0f0b20;padding:10px 15px;border-radius:2px;font-size:12px;line-height:18px;font-weight:300}#badges.svelte-v3egmx{grid-column:1/2;grid-row:2/4}#friends.svelte-v3egmx{grid-column:2 / auto;grid-row:2/3}#groups.svelte-v3egmx{grid-column:2 / auto;grid-row:3/4}@media only screen and (max-width: 600px){#badges.svelte-v3egmx{grid-column:1/3}}@media only screen and (max-width: 600px){#friends.svelte-v3egmx{grid-column:1/3;grid-row:4}}@media only screen and (max-width: 600px){#groups.svelte-v3egmx{grid-column:1/3;grid-row:5}}",
	map: "{\"version\":3,\"file\":\"ProfileTile.svelte\",\"sources\":[\"ProfileTile.svelte\"],\"sourcesContent\":[\"<script>\\n  import MainBadge from './MainBadge.svelte'\\n  import Showcase from './Showcase.svelte'\\n\\n  export let name, number, id\\n</script>\\n\\n<div {id}>\\n  <div id=\\\"title\\\">\\n    <h3>{name}</h3>\\n    <h2>{number}</h2>\\n  </div>\\n  {#if name === 'Badges'}\\n    <MainBadge />\\n    <Showcase\\n      images={[{ link: 'https://steamcommunity-a.akamaihd.net/public/images/badges/37_summer2019/level25_80.png' }, { link: 'https://steamcdn-a.akamaihd.net/steamcommunity/public/images/items/730/54e40b9e2288fbab8bd4c6537b0325d405c7e1b0.png' }, { link: 'https://steamcommunity-a.akamaihd.net/public/images/badges/28_springcleaning2018/bronze_80.png' }, { link: 'https://steamcdn-a.akamaihd.net/steamcommunity/public/images/items/762800/d467ec8eaed4643c47fbed43ed781daef2525963.png' }, { link: 'https://steamcommunity-a.akamaihd.net/public/images/badges/27_steamawardnominations/level04_80.png' }]} />\\n  {:else if name === 'Friends'}\\n    <Showcase\\n      images={[{ link: 'https://steamcdn-a.akamaihd.net/steamcommunity/public/images/avatars/8f/8fee180ace401f3bd50d5b96f7d19ab8da65553b_full.jpg' }, { link: 'https://steamcdn-a.akamaihd.net/steamcommunity/public/images/avatars/8f/8fee180ace401f3bd50d5b96f7d19ab8da65553b_full.jpg' }, { link: 'https://steamcdn-a.akamaihd.net/steamcommunity/public/images/avatars/8f/8fee180ace401f3bd50d5b96f7d19ab8da65553b_full.jpg' }, { link: 'https://steamcdn-a.akamaihd.net/steamcommunity/public/images/avatars/8f/8fee180ace401f3bd50d5b96f7d19ab8da65553b_full.jpg' }, { link: 'https://steamcdn-a.akamaihd.net/steamcommunity/public/images/avatars/8f/8fee180ace401f3bd50d5b96f7d19ab8da65553b_full.jpg' }]} />\\n  {:else if name === 'Groups'}\\n    <Showcase\\n      images={[{ link: 'https://steamcommunity-a.akamaihd.net/public/images/badges/37_summer2019/level25_80.png' }, { link: 'https://steamcdn-a.akamaihd.net/steamcommunity/public/images/items/730/54e40b9e2288fbab8bd4c6537b0325d405c7e1b0.png' }, { link: 'https://steamcommunity-a.akamaihd.net/public/images/badges/28_springcleaning2018/bronze_80.png' }, { link: 'https://steamcdn-a.akamaihd.net/steamcommunity/public/images/items/762800/d467ec8eaed4643c47fbed43ed781daef2525963.png' }, { link: 'https://steamcommunity-a.akamaihd.net/public/images/badges/27_steamawardnominations/level04_80.png' }]} />\\n  {/if}\\n</div>\\n\\n<style>\\n  #title {\\n    justify-content: space-between;\\n    display: flex;\\n    margin-bottom: 10px;\\n  }\\n\\n  h2 {\\n    font-weight: 500;\\n    color: #027aff;\\n  }\\n\\n  #badges,\\n  #friends,\\n  #groups {\\n    background-color: #0f0b20;\\n    padding: 10px 15px;\\n    border-radius: 2px;\\n    font-size: 12px;\\n    line-height: 18px;\\n    font-weight: 300;\\n  }\\n\\n  #badges {\\n    grid-column: 1/2;\\n    grid-row: 2/4;\\n  }\\n\\n  #friends {\\n    grid-column: 2 / auto;\\n    grid-row: 2/3;\\n  }\\n\\n  #groups {\\n    grid-column: 2 / auto;\\n    grid-row: 3/4;\\n  }\\n\\n  @media only screen and (max-width: 600px) {\\n    #badges {\\n      grid-column: 1/3;\\n    }\\n  }\\n\\n  @media only screen and (max-width: 600px) {\\n    #friends {\\n      grid-column: 1/3;\\n      grid-row: 4;\\n    }\\n  }\\n\\n  @media only screen and (max-width: 600px) {\\n    #groups {\\n      grid-column: 1/3;\\n      grid-row: 5;\\n    }\\n  }\\n</style>\\n\"],\"names\":[],\"mappings\":\"AA0BE,MAAM,cAAC,CAAC,AACN,eAAe,CAAE,aAAa,CAC9B,OAAO,CAAE,IAAI,CACb,aAAa,CAAE,IAAI,AACrB,CAAC,AAED,EAAE,cAAC,CAAC,AACF,WAAW,CAAE,GAAG,CAChB,KAAK,CAAE,OAAO,AAChB,CAAC,AAED,qBAAO,CACP,sBAAQ,CACR,OAAO,cAAC,CAAC,AACP,gBAAgB,CAAE,OAAO,CACzB,OAAO,CAAE,IAAI,CAAC,IAAI,CAClB,aAAa,CAAE,GAAG,CAClB,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,IAAI,CACjB,WAAW,CAAE,GAAG,AAClB,CAAC,AAED,OAAO,cAAC,CAAC,AACP,WAAW,CAAE,CAAC,CAAC,CAAC,CAChB,QAAQ,CAAE,CAAC,CAAC,CAAC,AACf,CAAC,AAED,QAAQ,cAAC,CAAC,AACR,WAAW,CAAE,CAAC,CAAC,CAAC,CAAC,IAAI,CACrB,QAAQ,CAAE,CAAC,CAAC,CAAC,AACf,CAAC,AAED,OAAO,cAAC,CAAC,AACP,WAAW,CAAE,CAAC,CAAC,CAAC,CAAC,IAAI,CACrB,QAAQ,CAAE,CAAC,CAAC,CAAC,AACf,CAAC,AAED,OAAO,IAAI,CAAC,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACzC,OAAO,cAAC,CAAC,AACP,WAAW,CAAE,CAAC,CAAC,CAAC,AAClB,CAAC,AACH,CAAC,AAED,OAAO,IAAI,CAAC,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACzC,QAAQ,cAAC,CAAC,AACR,WAAW,CAAE,CAAC,CAAC,CAAC,CAChB,QAAQ,CAAE,CAAC,AACb,CAAC,AACH,CAAC,AAED,OAAO,IAAI,CAAC,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACzC,OAAO,cAAC,CAAC,AACP,WAAW,CAAE,CAAC,CAAC,CAAC,CAChB,QAAQ,CAAE,CAAC,AACb,CAAC,AACH,CAAC\"}"
};

const ProfileTile = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div${add_attribute("id", id, 0)} class="${"svelte-v3egmx"}"><div id="${"title"}" class="${"svelte-v3egmx"}"><h3>${escape(name)}</h3>
    <h2 class="${"svelte-v3egmx"}">${escape(number)}</h2></div>
  ${name === "Badges"
	? `${validate_component(MainBadge, "MainBadge").$$render($$result, {}, {}, {})}
...
const css$9 = {
	code: "main.svelte-p06umt{display:grid;grid-template-rows:repeat(3, auto);grid-template-columns:repeat(auto-fit, minmax(192px, 50%));grid-gap:15px}",
	map: "{\"version\":3,\"file\":\"About.svelte\",\"sources\":[\"About.svelte\"],\"sourcesContent\":[\"<script>\\n  import AboutMeTile from './AboutMeTile.svelte'\\n  import ProfileTile from './ProfileTile.svelte'\\n  // import Artwork from './Badges.svelte'\\n  // import Comments from './Badges.svelte'\\n</script>\\n\\n<main>\\n  <AboutMeTile />\\n  <ProfileTile id=\\\"badges\\\" name=\\\"Badges\\\" number=\\\"14\\\" />\\n  <ProfileTile id=\\\"friends\\\" name=\\\"Friends\\\" number=\\\"28\\\" />\\n  <ProfileTile id=\\\"groups\\\" name=\\\"Groups\\\" number=\\\"8\\\" />\\n  <!-- <Artwork /> -->\\n  <!-- <Comments /> -->\\n</main>\\n\\n<style>\\n  main {\\n    display: grid;\\n    grid-template-rows: repeat(3, auto);\\n    grid-template-columns: repeat(auto-fit, minmax(192px, 50%));\\n    grid-gap: 15px;\\n  }\\n</style>\\n\"],\"names\":[],\"mappings\":\"AAiBE,IAAI,cAAC,CAAC,AACJ,OAAO,CAAE,IAAI,CACb,kBAAkB,CAAE,OAAO,CAAC,CAAC,CAAC,IAAI,CAAC,CACnC,qBAAqB,CAAE,OAAO,QAAQ,CAAC,CAAC,OAAO,KAAK,CAAC,CAAC,GAAG,CAAC,CAAC,CAC3D,QAAQ,CAAE,IAAI,AAChB,CAAC\"}"
};

const About = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	$$result.css.add(css$9);

	return `<main class="${"svelte-p06umt"}">${validate_component(AboutMeTile, "AboutMeTile").$$render($$result, {}, {}, {})}
  ${validate_component(ProfileTile, "ProfileTile").$$render(
		$$result,
		{
			id: "badges",
			name: "Badges",
...
const css$a = {
	code: "#container.svelte-1ttnfi1.svelte-1ttnfi1{padding:20px 30px}#profile.svelte-1ttnfi1.svelte-1ttnfi1{padding:60px 0px}#navtray.svelte-1ttnfi1.svelte-1ttnfi1{padding:0px 30px;display:flex;justify-content:space-between;align-items:center;font-size:12px;font-weight:500}#navtray.svelte-1ttnfi1 div.svelte-1ttnfi1{background-color:#0f0b20;width:22%;height:30px;display:flex;justify-content:center;align-items:center;border-radius:2px}.selected.svelte-1ttnfi1.svelte-1ttnfi1{border:1px solid #027aff}",
	map: "{\"version\":3,\"file\":\"profile.svelte\",\"sources\":[\"profile.svelte\"],\"sourcesContent\":[\"<script>\\n  import Navbar from '../components/Navbar.svelte'\\n  import Tabbar from '../components/Tabbar.svelte'\\n  import ProfileHeader from '../components/ProfileHeader.svelte'\\n  import About from '../components/About.svelte'\\n  import { username } from './stores.js'\\n  import { Router, Link, Route } from 'svelte-routing'\\n\\n  let username_value\\n\\n  const unsubscribe = username.subscribe((value) => {\\n    username_value = value\\n  })\\n</script>\\n\\n<svelte:head>\\n  <title>Profile :: Steam Mobile</title>\\n</svelte:head>\\n\\n<Navbar title=\\\"Profile\\\" />\\n<div id=\\\"profile\\\">\\n  <ProfileHeader\\n    name={username_value}\\n    alias=\\\"bingotheslayer\\\"\\n    profilepicture=\\\"profilepicture.jpg\\\"\\n    level=\\\"40\\\" />\\n  <div id=\\\"navtray\\\">\\n    <div class=\\\"selected\\\">About</div>\\n    <div>Activity</div>\\n    <div>Inventory</div>\\n  </div>\\n  <div id=\\\"container\\\">\\n    <About />\\n  </div>\\n</div>\\n<Tabbar location={2} />\\n\\n<style>\\n  #container {\\n    padding: 20px 30px;\\n  }\\n\\n  #profile {\\n    padding: 60px 0px;\\n  }\\n\\n  #navtray {\\n    padding: 0px 30px;\\n    display: flex;\\n    justify-content: space-between;\\n    align-items: center;\\n    font-size: 12px;\\n    font-weight: 500;\\n  }\\n\\n  #navtray div {\\n    background-color: #0f0b20;\\n    width: 22%;\\n    height: 30px;\\n    display: flex;\\n    justify-content: center;\\n    align-items: center;\\n    border-radius: 2px;\\n  }\\n\\n  .selected {\\n    border: 1px solid #027aff;\\n  }\\n</style>\\n\"],\"names\":[],\"mappings\":\"AAsCE,UAAU,8BAAC,CAAC,AACV,OAAO,CAAE,IAAI,CAAC,IAAI,AACpB,CAAC,AAED,QAAQ,8BAAC,CAAC,AACR,OAAO,CAAE,IAAI,CAAC,GAAG,AACnB,CAAC,AAED,QAAQ,8BAAC,CAAC,AACR,OAAO,CAAE,GAAG,CAAC,IAAI,CACjB,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,aAAa,CAC9B,WAAW,CAAE,MAAM,CACnB,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,GAAG,AAClB,CAAC,AAED,uBAAQ,CAAC,GAAG,eAAC,CAAC,AACZ,gBAAgB,CAAE,OAAO,CACzB,KAAK,CAAE,GAAG,CACV,MAAM,CAAE,IAAI,CACZ,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,MAAM,CACvB,WAAW,CAAE,MAAM,CACnB,aAAa,CAAE,GAAG,AACpB,CAAC,AAED,SAAS,8BAAC,CAAC,AACT,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,OAAO,AAC3B,CAAC\"}"
};
...
<div id="${"profile"}" class="${"svelte-1ttnfi1"}">${validate_component(ProfileHeader, "ProfileHeader").$$render(
		$$result,
		{
			name: username_value,
			alias: "bingotheslayer",
  ...
  <div id="${"navtray"}" class="${"svelte-1ttnfi1"}"><div class="${"selected svelte-1ttnfi1"}">About</div>
    <div class="${"svelte-1ttnfi1"}">Activity</div>
    <div class="${"svelte-1ttnfi1"}">Inventory</div></div>
  <div id="${"container"}" class="${"svelte-1ttnfi1"}">${validate_component(About, "About").$$render($$result, {}, {}, {})}</div></div>
...
const css$l = {
	code: "#tabs.svelte-146ai4i{display:flex;padding:0px 30px;width:145px;justify-content:space-between;align-items:center}h3.svelte-146ai4i{color:#9099a1;text-transform:uppercase;font-weight:400;font-size:12px;opacity:0.8}ul.svelte-146ai4i{list-style:none;padding:0px 30px;background-color:#0f0b20;position:relative;margin:0}#card.svelte-146ai4i{margin-top:30px}.selectedtab.svelte-146ai4i{color:#027aff;font-weight:600}#tabscontainer.svelte-146ai4i{position:sticky;padding-top:30px;padding-bottom:10px;top:200px;z-index:998;background-color:black}",
	map: "{\"version\":3,\"file\":\"Chats.svelte\",\"sources\":[\"Chats.svelte\"],\"sourcesContent\":[\"<script>\\n  import ChatsTile from './ChatsTile.svelte'\\n  let offline = false,\\n    onlineusers = 3,\\n    offlineusers = 2\\n</script>\\n\\n<!-- status codes\\n  1 = ingame, 2 online, 3 offline\\nstatus codes -->\\n\\n<div id=\\\"card\\\">\\n  <div id=\\\"tabscontainer\\\">\\n    <div id=\\\"tabs\\\">\\n      <h3\\n        class={!offline ? 'selectedtab' : ''}\\n        on:click={() => {\\n          offline = false\\n        }}>\\n        Online ({onlineusers})\\n      </h3>\\n      <h3\\n        class={offline ? 'selectedtab' : ''}\\n        on:click={() => {\\n          offline = true\\n        }}>\\n        Offline ({offlineusers})\\n      </h3>\\n    </div>\\n  </div>\\n  {#if !offline}\\n    <ul>\\n      <ChatsTile\\n        userName=\\\"bingotheslayer\\\"\\n        gameName=\\\"Dank Souls 3\\\"\\n        userImage=\\\"friendone.png\\\"\\n        status={1}\\n        {offline} />\\n      <ChatsTile\\n        userName=\\\"fatherdeath\\\"\\n        userImage=\\\"friendtwo.png\\\"\\n        status={2}\\n        {offline} />\\n      <ChatsTile\\n        userName=\\\"pyschotherapist\\\"\\n        userImage=\\\"friendthree.png\\\"\\n        status={2}\\n        {offline} />\\n    </ul>\\n  {/if}\\n  {#if offline}\\n    <ul>\\n      <ChatsTile\\n        userName=\\\"fatfather64\\\"\\n        gameName=\\\"Grand Theft Auto: San Andreas\\\"\\n        userImage=\\\"friendfour.png\\\"\\n        status={3}\\n        {offline}\\n        timestamp=\\\"6\\\" />\\n      <ChatsTile\\n        userName=\\\"dingdongding\\\"\\n        gameName=\\\"Grand Theft Auto: San Andreas\\\"\\n        userImage=\\\"profilepicture.jpg\\\"\\n        status={3}\\n        {offline}\\n        timestamp=\\\"12\\\" />\\n    </ul>\\n  {/if}\\n</div>\\n\\n<style>\\n  #tabs {\\n    display: flex;\\n    padding: 0px 30px;\\n    width: 145px;\\n    justify-content: space-between;\\n    align-items: center;\\n  }\\n  h3 {\\n    color: #9099a1;\\n    text-transform: uppercase;\\n    font-weight: 400;\\n    font-size: 12px;\\n    opacity: 0.8;\\n  }\\n  ul {\\n    list-style: none;\\n    padding: 0px 30px;\\n    background-color: #0f0b20;\\n    position: relative;\\n    margin: 0;\\n  }\\n  #card {\\n    margin-top: 30px;\\n  }\\n  .selectedtab {\\n    color: #027aff;\\n    font-weight: 600;\\n  }\\n  #tabscontainer {\\n    position: sticky;\\n    padding-top: 30px;\\n    padding-bottom: 10px;\\n    top: 200px;\\n    z-index: 998;\\n    background-color: black;\\n  }\\n</style>\\n\"],\"names\":[],\"mappings\":\"AAuEE,KAAK,eAAC,CAAC,AACL,OAAO,CAAE,IAAI,CACb,OAAO,CAAE,GAAG,CAAC,IAAI,CACjB,KAAK,CAAE,KAAK,CACZ,eAAe,CAAE,aAAa,CAC9B,WAAW,CAAE,MAAM,AACrB,CAAC,AACD,EAAE,eAAC,CAAC,AACF,KAAK,CAAE,OAAO,CACd,cAAc,CAAE,SAAS,CACzB,WAAW,CAAE,GAAG,CAChB,SAAS,CAAE,IAAI,CACf,OAAO,CAAE,GAAG,AACd,CAAC,AACD,EAAE,eAAC,CAAC,AACF,UAAU,CAAE,IAAI,CAChB,OAAO,CAAE,GAAG,CAAC,IAAI,CACjB,gBAAgB,CAAE,OAAO,CACzB,QAAQ,CAAE,QAAQ,CAClB,MAAM,CAAE,CAAC,AACX,CAAC,AACD,KAAK,eAAC,CAAC,AACL,UAAU,CAAE,IAAI,AAClB,CAAC,AACD,YAAY,eAAC,CAAC,AACZ,KAAK,CAAE,OAAO,CACd,WAAW,CAAE,GAAG,AAClB,CAAC,AACD,cAAc,eAAC,CAAC,AACd,QAAQ,CAAE,MAAM,CAChB,WAAW,CAAE,IAAI,CACjB,cAAc,CAAE,IAAI,CACpB,GAAG,CAAE,KAAK,CACV,OAAO,CAAE,GAAG,CACZ,gBAAgB,CAAE,KAAK,AACzB,CAAC\"}"
};
...
<div id="${"card"}" class="${"svelte-146ai4i"}"><div id="${"tabscontainer"}" class="${"svelte-146ai4i"}"><div id="${"tabs"}" class="${"svelte-146ai4i"}"><h3 class="${escape(null_to_empty( "selectedtab" )) + " svelte-146ai4i"}">Online (${escape(onlineusers)})
      </h3>
      <h3 class="${escape(null_to_empty( "")) + " svelte-146ai4i"}">Offline (${escape(offlineusers)})
      </h3></div></div>
  ${ `<ul class="${"svelte-146ai4i"}">${validate_component(ChatsTile, "ChatsTile").$$render(
			$$result,
			{
				userName: "bingotheslayer",
				gameName: "Dank Souls 3",
