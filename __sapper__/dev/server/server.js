...
const css$4 = {
	code: "#head.svelte-bla0wa{position:relative}#userinfo.svelte-bla0wa{margin-left:18px}#level.svelte-bla0wa{margin-left:auto;font-size:16px;font-weight:300;border:2px solid #467a3c;border-radius:50%;margin-bottom:12px;width:35px;height:35px;display:flex;justify-content:center;align-items:center}h3.svelte-bla0wa{font-size:20px;font-weight:500;line-height:1}h5.svelte-bla0wa{font-size:14px;font-weight:300;line-height:1;color:#696969}#profilepicture.svelte-bla0wa{background-size:cover;background-repeat:no-repeat;height:75px;width:75px;border-radius:2px}#layer1.svelte-bla0wa{position:absolute;height:50px;background:linear-gradient(to top, rgb(0, 0, 0), rgba(0, 0, 0, 0));bottom:0;width:100%;z-index:975}#contentwrapper.svelte-bla0wa{position:absolute;z-index:99;width:100%}#content.svelte-bla0wa{padding:30px;display:flex;align-items:center}#layer2.svelte-bla0wa{background-size:cover;width:100%;height:140px;background-repeat:no-repeat;z-index:3;position:relative;opacity:0.1}@media only screen and (min-width: 600px){#layer2.svelte-bla0wa{background-position:0px -100px}}#layer3.svelte-bla0wa{background:#0f0b20;height:140px;width:100%;position:absolute;top:0;z-index:2}",
	map: "{\"version\":3,\"file\":\"ProfileHeader.svelte\",\"sources\":[\"ProfileHeader.svelte\"],\"sourcesContent\":[\"<script>\\n  export let alias, name, profilePicture, level\\n</script>\\n\\n<main>\\n  <div id=\\\"head\\\">\\n    <div id=\\\"layer1\\\" />\\n    <div id=\\\"contentwrapper\\\">\\n      <div id=\\\"content\\\">\\n        <div\\n          id=\\\"profilepicture\\\"\\n          style=\\\"background-image: url({profilePicture});\\\" />\\n        <div id=\\\"userinfo\\\">\\n          <h3>{alias}</h3>\\n          <h5>{name}</h5>\\n        </div>\\n        <!-- need to right logic for handling badge color -->\\n        <div id=\\\"level\\\">{level}</div>\\n        <!-- need to right logic for handling badge color -->\\n      </div>\\n    </div>\\n    <div id=\\\"layer2\\\" style=\\\"background-image: url(gta.jpg);\\\" />\\n    <div id=\\\"layer3\\\" />\\n  </div>\\n</main>\\n\\n<style>\\n  #head {\\n    position: relative;\\n  }\\n\\n  #userinfo {\\n    margin-left: 18px;\\n  }\\n\\n  #level {\\n    margin-left: auto;\\n    font-size: 16px;\\n    font-weight: 300;\\n    border: 2px solid #467a3c;\\n    border-radius: 50%;\\n    margin-bottom: 12px;\\n    width: 35px;\\n    height: 35px;\\n    display: flex;\\n    justify-content: center;\\n    align-items: center;\\n  }\\n\\n  h3 {\\n    font-size: 20px;\\n    font-weight: 500;\\n    line-height: 1;\\n  }\\n\\n  h5 {\\n    font-size: 14px;\\n    font-weight: 300;\\n    line-height: 1;\\n    color: #696969;\\n  }\\n\\n  #profilepicture {\\n    background-size: cover;\\n    background-repeat: no-repeat;\\n    height: 75px;\\n    width: 75px;\\n    border-radius: 2px;\\n  }\\n\\n  #layer1 {\\n    position: absolute;\\n    height: 50px;\\n    background: linear-gradient(to top, rgb(0, 0, 0), rgba(0, 0, 0, 0));\\n    bottom: 0;\\n    width: 100%;\\n    z-index: 975;\\n  }\\n\\n  #contentwrapper {\\n    position: absolute;\\n    z-index: 99;\\n    width: 100%;\\n  }\\n\\n  #content {\\n    padding: 30px;\\n    display: flex;\\n    align-items: center;\\n  }\\n\\n  #layer2 {\\n    background-size: cover;\\n    width: 100%;\\n    height: 140px;\\n    background-repeat: no-repeat;\\n    z-index: 3;\\n    position: relative;\\n    opacity: 0.1;\\n  }\\n\\n  @media only screen and (min-width: 600px) {\\n    #layer2 {\\n      background-position: 0px -100px;\\n    }\\n  }\\n\\n  #layer3 {\\n    background: #0f0b20;\\n    height: 140px;\\n    width: 100%;\\n    position: absolute;\\n    top: 0;\\n    z-index: 2;\\n  }\\n</style>\\n\"],\"names\":[],\"mappings\":\"AA2BE,KAAK,cAAC,CAAC,AACL,QAAQ,CAAE,QAAQ,AACpB,CAAC,AAED,SAAS,cAAC,CAAC,AACT,WAAW,CAAE,IAAI,AACnB,CAAC,AAED,MAAM,cAAC,CAAC,AACN,WAAW,CAAE,IAAI,CACjB,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,GAAG,CAChB,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,OAAO,CACzB,aAAa,CAAE,GAAG,CAClB,aAAa,CAAE,IAAI,CACnB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,MAAM,CACvB,WAAW,CAAE,MAAM,AACrB,CAAC,AAED,EAAE,cAAC,CAAC,AACF,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,GAAG,CAChB,WAAW,CAAE,CAAC,AAChB,CAAC,AAED,EAAE,cAAC,CAAC,AACF,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,GAAG,CAChB,WAAW,CAAE,CAAC,CACd,KAAK,CAAE,OAAO,AAChB,CAAC,AAED,eAAe,cAAC,CAAC,AACf,eAAe,CAAE,KAAK,CACtB,iBAAiB,CAAE,SAAS,CAC5B,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,IAAI,CACX,aAAa,CAAE,GAAG,AACpB,CAAC,AAED,OAAO,cAAC,CAAC,AACP,QAAQ,CAAE,QAAQ,CAClB,MAAM,CAAE,IAAI,CACZ,UAAU,CAAE,gBAAgB,EAAE,CAAC,GAAG,CAAC,CAAC,IAAI,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CACnE,MAAM,CAAE,CAAC,CACT,KAAK,CAAE,IAAI,CACX,OAAO,CAAE,GAAG,AACd,CAAC,AAED,eAAe,cAAC,CAAC,AACf,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,EAAE,CACX,KAAK,CAAE,IAAI,AACb,CAAC,AAED,QAAQ,cAAC,CAAC,AACR,OAAO,CAAE,IAAI,CACb,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,AACrB,CAAC,AAED,OAAO,cAAC,CAAC,AACP,eAAe,CAAE,KAAK,CACtB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,KAAK,CACb,iBAAiB,CAAE,SAAS,CAC5B,OAAO,CAAE,CAAC,CACV,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,GAAG,AACd,CAAC,AAED,OAAO,IAAI,CAAC,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACzC,OAAO,cAAC,CAAC,AACP,mBAAmB,CAAE,GAAG,CAAC,MAAM,AACjC,CAAC,AACH,CAAC,AAED,OAAO,cAAC,CAAC,AACP,UAAU,CAAE,OAAO,CACnB,MAAM,CAAE,KAAK,CACb,KAAK,CAAE,IAAI,CACX,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,CAAC,CACN,OAAO,CAAE,CAAC,AACZ,CAAC\"}"
};
...
const ProfileHeader = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<main><div id="${"head"}" class="${"svelte-bla0wa"}"><div id="${"layer1"}" class="${"svelte-bla0wa"}"></div>
    <div id="${"contentwrapper"}" class="${"svelte-bla0wa"}"><div id="${"content"}" class="${"svelte-bla0wa"}"><div id="${"profilepicture"}" style="${"background-image: url(" + escape(profilePicture) + ");"}" class="${"svelte-bla0wa"}"></div>
        <div id="${"userinfo"}" class="${"svelte-bla0wa"}"><h3 class="${"svelte-bla0wa"}">${escape(alias)}</h3>
          <h5 class="${"svelte-bla0wa"}">${escape(name)}</h5></div>
        
        <div id="${"level"}" class="${"svelte-bla0wa"}">${escape(level)}</div>
        </div></div>
    <div id="${"layer2"}" style="${"background-image: url(gta.jpg);"}" class="${"svelte-bla0wa"}"></div>
    <div id="${"layer3"}" class="${"svelte-bla0wa"}"></div></div>
</main>`;
});
...
const css$5 = {
	code: "#aboutme.svelte-1fo10hi{background-color:#0f0b20;padding:10px 15px;border-radius:2px;font-size:14px;line-height:18px;font-weight:300;display:flex;align-items:center;flex-direction:column;align-items:baseline;grid-column:1/3;min-height:38px}h3.svelte-1fo10hi{font-size:14px;color:#9099a1;margin-bottom:14px}",
	map: "{\"version\":3,\"file\":\"AboutMeTile.svelte\",\"sources\":[\"AboutMeTile.svelte\"],\"sourcesContent\":[\"<div id=\\\"aboutme\\\">\\n  <h3>About</h3>\\n  Hidetaka Miyazaki is god. Change my mind. Dank Souls has the best lore in any\\n  videogame. Waiting for Elden Ring...\\n</div>\\n\\n<style>\\n  #aboutme {\\n    background-color: #0f0b20;\\n    padding: 10px 15px;\\n    border-radius: 2px;\\n    font-size: 14px;\\n    line-height: 18px;\\n    font-weight: 300;\\n    display: flex;\\n    align-items: center;\\n    flex-direction: column;\\n    align-items: baseline;\\n    grid-column: 1/3;\\n    min-height: 38px;\\n  }\\n\\n  h3 {\\n    font-size: 14px;\\n    color: #9099a1;\\n    margin-bottom: 14px;\\n  }\\n</style>\\n\"],\"names\":[],\"mappings\":\"AAOE,QAAQ,eAAC,CAAC,AACR,gBAAgB,CAAE,OAAO,CACzB,OAAO,CAAE,IAAI,CAAC,IAAI,CAClB,aAAa,CAAE,GAAG,CAClB,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,IAAI,CACjB,WAAW,CAAE,GAAG,CAChB,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,cAAc,CAAE,MAAM,CACtB,WAAW,CAAE,QAAQ,CACrB,WAAW,CAAE,CAAC,CAAC,CAAC,CAChB,UAAU,CAAE,IAAI,AAClB,CAAC,AAED,EAAE,eAAC,CAAC,AACF,SAAS,CAAE,IAAI,CACf,KAAK,CAAE,OAAO,CACd,aAAa,CAAE,IAAI,AACrB,CAAC\"}"
};

const AboutMeTile = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	$$result.css.add(css$5);

	return `<div id="${"aboutme"}" class="${"svelte-1fo10hi"}"><h3 class="${"svelte-1fo10hi"}">About</h3>
  Hidetaka Miyazaki is god. Change my mind. Dank Souls has the best lore in any
  videogame. Waiting for Elden Ring...
</div>`;
});
...
const css$7 = {
	code: "#badgeshowcase.svelte-v6sofx img.svelte-v6sofx{height:36px}#badgeshowcase.svelte-v6sofx.svelte-v6sofx{display:flex;justify-content:space-between;align-items:center;margin-bottom:10px}",
	map: "{\"version\":3,\"file\":\"Showcase.svelte\",\"sources\":[\"Showcase.svelte\"],\"sourcesContent\":[\"<script>\\n  export let images, height, borderRadius\\n</script>\\n\\n<div id=\\\"badgeshowcase\\\">\\n  <img\\n    src={images[0].link}\\n    style=\\\"height: {images[0].height}; border-radius: {images[0].borderRadius}\\\" />\\n  <img\\n    src={images[1].link}\\n    style=\\\"height: {images[1].height}; border-radius: {images[0].borderRadius}\\\" />\\n  <img\\n    src={images[2].link}\\n    style=\\\"height: {images[2].height}; border-radius: {images[0].borderRadius}\\\" />\\n  <img\\n    src={images[3].link}\\n    style=\\\"height: {images[3].height}; border-radius: {images[0].borderRadius}\\\" />\\n  <img\\n    src={images[4].link}\\n    style=\\\"height: {images[4].height}; border-radius: {images[0].borderRadius}\\\" />\\n</div>\\n\\n<style>\\n  #badgeshowcase img {\\n    height: 36px;\\n  }\\n\\n  #badgeshowcase {\\n    display: flex;\\n    justify-content: space-between;\\n    align-items: center;\\n    margin-bottom: 10px;\\n  }\\n</style>\\n\"],\"names\":[],\"mappings\":\"AAuBE,4BAAc,CAAC,GAAG,cAAC,CAAC,AAClB,MAAM,CAAE,IAAI,AACd,CAAC,AAED,cAAc,4BAAC,CAAC,AACd,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,aAAa,CAC9B,WAAW,CAAE,MAAM,CACnB,aAAa,CAAE,IAAI,AACrB,CAAC\"}"
};
...
const Showcase = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div id="${"badgeshowcase"}" class="${"svelte-v6sofx"}"><img${add_attribute("src", images[0].link, 0)} style="${"height: " + escape(images[0].height) + "; border-radius: " + escape(images[0].borderRadius)}" class="${"svelte-v6sofx"}">
  <img${add_attribute("src", images[1].link, 0)} style="${"height: " + escape(images[1].height) + "; border-radius: " + escape(images[0].borderRadius)}" class="${"svelte-v6sofx"}">
  <img${add_attribute("src", images[2].link, 0)} style="${"height: " + escape(images[2].height) + "; border-radius: " + escape(images[0].borderRadius)}" class="${"svelte-v6sofx"}">
  <img${add_attribute("src", images[3].link, 0)} style="${"height: " + escape(images[3].height) + "; border-radius: " + escape(images[0].borderRadius)}" class="${"svelte-v6sofx"}">
  <img${add_attribute("src", images[4].link, 0)} style="${"height: " + escape(images[4].height) + "; border-radius: " + escape(images[0].borderRadius)}" class="${"svelte-v6sofx"}">
</div>`;
});
...
const ProfileTile = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div${add_attribute("id", id, 0)} class="${"svelte-vttx3g"}"><div id="${"title"}" class="${"svelte-vttx3g"}"><h3 class="${"svelte-vttx3g"}">${escape(name)}</h3>
    <h2 class="${"svelte-vttx3g"}">${escape(number)}</h2></div>
  ${name === "Badges"
...
${validate_component(Artwork, "Artwork").$$render($$result, {}, {}, {})}`;
});

/* src/routes/profile.svelte generated by Svelte v3.22.2 */

const css$b = {
	code: "#container.svelte-1yf3v8h.svelte-1yf3v8h{padding:20px 20px}#profile.svelte-1yf3v8h.svelte-1yf3v8h{padding:60px 0px}#navtray.svelte-1yf3v8h.svelte-1yf3v8h{padding:0px 20px;display:flex;justify-content:space-between;align-items:center;font-size:12px;font-weight:500}#navtray.svelte-1yf3v8h div.svelte-1yf3v8h{background-color:#0f0b20;width:22%;height:30px;display:flex;justify-content:center;align-items:center;border-radius:2px}.selected.svelte-1yf3v8h.svelte-1yf3v8h{border:1px solid #027aff}",
...
<div id="${"profile"}" class="${"svelte-1yf3v8h"}">${validate_component(ProfileHeader, "ProfileHeader").$$render(
		$$result,
		{
			name: username_value,
			alias: "bingotheslayer",
  ...
  <div id="${"navtray"}" class="${"svelte-1yf3v8h"}"><div class="${"selected svelte-1yf3v8h"}">About</div>
    <div class="${"svelte-1yf3v8h"}">Activity</div>
    <div class="${"svelte-1yf3v8h"}">Inventory</div></div>
  <div id="${"container"}" class="${"svelte-1yf3v8h"}">${validate_component(About, "About").$$render($$result, {}, {}, {})}</div></div>
...
<div id="${"support"}" class="${"svelte-1pwsucv"}">${validate_component(SupportCard, "SupportCard").$$render($$result, { title: "Recent Products" }, {}, {})}
  ...
  <h5 class="${"svelte-1pwsucv"}">rohanharikr /
    <i>commit</i>
    ${escape(version)}</h5></div>
