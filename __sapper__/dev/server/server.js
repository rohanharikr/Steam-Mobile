...
const css = {
	code: "#navbar.svelte-4cp4of{background-color:#0a1226;height:60px;display:flex;justify-content:space-between;align-items:center;padding:0px 30px;color:#9099a1;font-weight:500}",
