...
const css = {
	code: "#navbar.svelte-b7vd3s{background-color:#0a1226;height:60px;display:flex;justify-content:space-between;align-items:center;padding:0px 30px;color:#9099a1;font-weight:500;font-size:18px}",
	map: "{\"version\":3,\"file\":\"Navbar.svelte\",\"sources\":[\"Navbar.svelte\"],\"sourcesContent\":[\"<script>\\n  import Headroom from 'svelte-headroom'\\n  export let title\\n</script>\\n\\n<Headroom duration=\\\"150ms\\\" offset={50} tolerance={5}>\\n  <div id=\\\"navbar\\\">\\n    <div>\\n      <img src=\\\"search.svg\\\" />\\n    </div>\\n    <div>{title}</div>\\n    <div>\\n      <img src=\\\"filter.svg\\\" height=\\\"12px;\\\" />\\n    </div>\\n  </div>\\n</Headroom>\\n\\n<style>\\n  #navbar {\\n    background-color: #0a1226;\\n    height: 60px;\\n    display: flex;\\n    justify-content: space-between;\\n    align-items: center;\\n    padding: 0px 30px;\\n    color: #9099a1;\\n    font-weight: 500;\\n    font-size: 18px;\\n  }\\n</style>\\n\"],\"names\":[],\"mappings\":\"AAkBE,OAAO,cAAC,CAAC,AACP,gBAAgB,CAAE,OAAO,CACzB,MAAM,CAAE,IAAI,CACZ,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,aAAa,CAC9B,WAAW,CAAE,MAAM,CACnB,OAAO,CAAE,GAAG,CAAC,IAAI,CACjB,KAAK,CAAE,OAAO,CACd,WAAW,CAAE,GAAG,CAChB,SAAS,CAAE,IAAI,AACjB,CAAC\"}"
};
...
const Navbar = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${validate_component(Headroom, "Headroom").$$render(
		...
		{},
		{
			default: () => `<div id="${"navbar"}" class="${"svelte-b7vd3s"}"><div><img src="${"search.svg"}"></div>
...
const css$1 = {
	code: "#tabbar.svelte-pgoyug.svelte-pgoyug{background-color:#171a21;height:65px;display:flex;justify-content:space-between;align-items:center;padding:0px 30px;color:#9099a1;font-weight:500;position:fixed;bottom:0;left:0;right:0;z-index:999}.tabItem.svelte-pgoyug.svelte-pgoyug{display:flex;flex-direction:column;font-size:12px;align-items:center}.tabItem.svelte-pgoyug img.svelte-pgoyug{margin-bottom:6px;height:20px}.selected.svelte-pgoyug.svelte-pgoyug{color:white;font-weight:600}",
...
const Tabbar = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div id="${"tabbar"}" class="${"svelte-pgoyug"}"><a href="${"store"}"><div class="${"tabItem " + escape(location === 1 ? "selected" : "") + " svelte-pgoyug"}"><img${add_attribute("src", location == 1 ? "store-active.svg" : "store.svg", 0)} class="${"svelte-pgoyug"}">
      Store
    </div></a>
  <a href="${"profile"}"><div class="${"tabItem " + escape(location === 2 ? "selected" : "") + " svelte-pgoyug"}"><img${add_attribute("src", location == 2 ? "profile-active.svg" : "profile.svg", 0)} class="${"svelte-pgoyug"}">
      Profile
    </div></a>
  <a href="${"./"}"><div class="${"tabItem " + escape(location === 3 ? "selected" : "") + " svelte-pgoyug"}"><img${add_attribute("src", location == 3 ? "guard-active.svg" : "guard.svg", 0)} class="${"svelte-pgoyug"}">
      Guard
    </div></a>
  <a href="${"chat"}"><div class="${"tabItem " + escape(location === 4 ? "selected" : "") + " svelte-pgoyug"}"><img${add_attribute("src", location == 4 ? "chat-active.svg" : "chat.svg", 0)} class="${"svelte-pgoyug"}">
      Chat
    </div></a>
  <a href="${"support"}"><div class="${"tabItem " + escape(location === 5 ? "selected" : "") + " svelte-pgoyug"}"><img${add_attribute("src", location == 5 ? "support-active.svg" : "support.svg", 0)} class="${"svelte-pgoyug"}">
      Support
    </div></a>
</div>`;
});
